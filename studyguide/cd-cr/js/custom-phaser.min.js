...
(function () {
  function t(t, e, i, n) {
    ...
    return (
      ...
      t.texParameteri(
        ...
        n === s.scaleModes.LINEAR ? t.LINEAR : t.NEAREST
      ),
      t.texParameteri(
        t.TEXTURE_2D,
  ...
  function e(e, i, s, r, o) {
    ...
    return (
      ...
      (l = e.checkFramebufferStatus(e.FRAMEBUFFER)) !==
        e.FRAMEBUFFER_COMPLETE &&
        console.error("Incomplete GL framebuffer. ", n[l]),
      (a.width = i),
      (a.height = s),
      (a.targetTexture = u),
      (a.renderBuffer = h),
  ...
  (s.DisplayObject = function () {
    ...
    (s.DisplayObject.prototype = {
      ...
      updateTransform: function (t) {
        ...
        if (i || s) {
          ...
          (this.worldRotation =
            Phaser.Math.HALF_PI -
            (r > 0 ? Math.acos(-n / d) : -Math.acos(n / d))),
        ...
        return (
          ...
          this.transformCallback &&
            this.transformCallback.call(this.transformCallbackContext, u, h),
          this
        );
      },
      preUpdate: function () {},
      ...
      _generateCachedSprite: function () {
        ...
        if (
          ...
          this.texture &&
            ...
            (e = this.texture.baseTexture.textureIndex);
          var i = new Phaser.RenderTexture(
            this.game,
            t.width,
            t.height,
            void 0,
    ...
    (s.DisplayObject.prototype.displayObjectUpdateTransform =
      s.DisplayObject.prototype.updateTransform),
    Object.defineProperties(s.DisplayObject.prototype, {
      ...
      filters: {
        ...
        set: function (t) {
          ...
          (this._filters = t),
            this.blendMode &&
              this.blendMode === s.blendModes.MULTIPLY &&
    ...
    (s.DisplayObjectContainer.prototype = Object.create(
      s.DisplayObject.prototype
    )),
    ...
    (s.DisplayObjectContainer.prototype.displayObjectContainerUpdateTransform =
      s.DisplayObjectContainer.prototype.updateTransform),
    (s.DisplayObjectContainer.prototype.getBounds = function (t) {
      ...
      if (e) {
        ...
        for (
          t.worldTransform = Phaser.identityMatrix, n = 0;
          n < t.children.length;
          n++
        )
      ...
      if (((f.x = u), (f.y = l), (f.width = c - u), (f.height = d - l), e))
        for (t.worldTransform = r, n = 0; n < t.children.length; n++)
          t.children[n].updateTransform();
      if (!i) {
        var D = t.getBounds();
        (f.x -= D.x), (f.y -= D.y);
    ...
    (s.Sprite = function (t) {
      s.DisplayObjectContainer.call(this),
        (this.anchor = new s.Point(
          s.Sprite.defaultAnchor.x,
          s.Sprite.defaultAnchor.y
        )),
    ...
    (s.Sprite.defaultAnchor = { x: 0, y: 0 }),
    ...
    (s.Sprite.prototype.getBounds = function (t) {
      ...
      if (0 === u && 0 === l) {
        ...
        var x = h * n + l * o + d,
          ...
          P = c * r + u * n + p;
        (m =
          S < (m = w < (m = b < (m = x < m ? x : m) ? b : m) ? w : m) ? S : m),
          (y =
            P < (y = C < (y = T < (y = _ < y ? _ : y) ? T : y) ? C : y)
              ? P
              : y),
          (f =
            S > (f = w > (f = b > (f = x > f ? x : f) ? b : f) ? w : f)
              ? S
              : f),
          (g =
            P > (g = C > (g = T > (g = _ > g ? _ : g) ? T : g) ? C : g)
              ? P
              : g);
      }
      var E = this._bounds;
    ...
    (s.Sprite.prototype.getLocalBounds = function () {
      ...
      for (this.worldTransform = t, e = 0; e < this.children.length; e++)
        this.children[e].updateTransform();
      return i;
    }),
    (s.Sprite.prototype._renderWebGL = function (t, e) {
      if (this.visible && !(this.alpha <= 0) && this.renderable) {
        ...
        if ((e && (i = e), this._mask || this._filters)) {
          var s = t.spriteBatch;
          this._filters &&
            (s.flush(), t.filterManager.pushFilter(this._filterBlock)),
            this._mask &&
              (s.stop(), t.maskManager.pushMask(this.mask, t), s.start()),
            s.render(this);
          for (n = 0; n < this.children.length; n++)
        ...
        if (
          ...
          this.blendMode !== t.currentBlendMode &&
            ...
            (t.context.globalCompositeOperation =
              s.blendModesCanvas[t.currentBlendMode])),
          this._mask && t.maskManager.pushMask(this._mask, t),
          this.texture.valid)
        ) {
          ...
          (t.context.globalAlpha = this.worldAlpha),
            t.smoothProperty &&
              ...
              (t.context[t.smoothProperty] =
                t.scaleMode === s.scaleModes.LINEAR));
          var r = this.texture.trim
          ...
          if (
            (t.roundPixels
              ? (t.context.setTransform(i.a, i.b, i.c, i.d, 0 | a, 0 | h),
                (r |= 0),
                (o |= 0))
              : t.context.setTransform(i.a, i.b, i.c, i.d, a, h),
            (r /= n),
            (o /= n),
            16777215 !== this.tint)
          )
            (this.texture.requiresReTint || this.cachedTint !== this.tint) &&
              ((this.tintedTexture = s.CanvasTinter.getTintedTexture(
                this,
                this.tint
              )),
    ...
    (s._CompileShader = function (t, e, i) {
      ...
      return (
        ...
        t.getShaderParameter(n, t.COMPILE_STATUS)
          ? n
          : (window.console.log(t.getShaderInfoLog(n)), null)
      );
    }),
    ...
    (s.PixiShader.prototype.initMultitexShader = function () {
      ...
      for (
        var e =
            "\tif (vTextureIndex == 0.0) { gl_FragColor = texture2D(uSamplerArray[0], vTextureCoord) * vColor;return;}\n",
          i = 1;
        i < this.MAX_TEXTURES;
        ++i
      )
        e +=
          "\tif (vTextureIndex == " +
          i +
          ".0) {gl_FragColor = texture2D(uSamplerArray[" +
          i +
          "], vTextureCoord) * vColor;return;}\n";
      this.fragmentSrc = [
        ...
        "   if(vTextureIndex >= " +
          this.MAX_TEXTURES +
          ".0) { gl_FragColor = BLUE;return;}",
        "   if(isnan(vTextureIndex)) { gl_FragColor = RED;return;}",
        "}",
      ];
      var n = s.compileProgram(
        t,
        this.vertexSrc || s.PixiShader.defaultVertexSrc,
        this.fragmentSrc
      );
      t.useProgram(n),
        ...
        "sampler2D" === s
          ...
          ? ((t.glMatrix = !0),
            ...
            "mat2" === s
              ...
              : "mat4" === s && (t.glFunc = e.uniformMatrix4fv))
          : ((t.glFunc = e["uniform" + s]),
            (t.glValueLength =
              "2f" === s || "2i" === s
                ? 2
                : "3f" === s || "3i" === s
    ...
    (s.PixiShader.prototype.initSampler2D = function (t) {
      if (t.value && t.value.baseTexture && t.value.baseTexture.hasLoaded) {
        var e = this.gl;
        if (
          (e.activeTexture(e.TEXTURE0 + this.textureCount),
    ...
    (s.PixiFastShader.prototype.init = function () {
      ...
      if (
        (t.useProgram(e),
        (this.uSampler = s._enableMultiTextureToggle
          ? t.getUniformLocation(e, "uSamplerArray[0]")
          : t.getUniformLocation(e, "uSampler")),
        s._enableMultiTextureToggle)
      ) {
        var i = [],
          n = t.createTexture();
    ...
    (s.StripShader = function (t) {
      if (
        ...
        for (
          var e =
              "\tif (vTextureIndex == 0.0) { gl_FragColor = texture2D(uSamplerArray[0], vTextureCoord);return;}\n",
            i = 1;
          i < this.MAX_TEXTURES;
          ++i
        )
      ...
      if (s._enableMultiTextureToggle) {
        for (
          var e = function (t) {
            ...
            i = this.gl,
            n = i.getParameter(i.MAX_TEXTURE_IMAGE_UNITS),
            r = i.getParameter(i.MAX_TEXTURE_SIZE),
            o = this.game.cache._cache.image,
            a = null,
            h = 0;
          h < this.currentBatchedTextures.length;
          h++
        )
          (a = this.currentBatchedTextures[h]) in o
            ? (o[a].base.textureIndex = 0)
            : console.warn(
                'setTexturePriority: There is no image "%s" in the image cache.',
                a
              );
        ...
        for (var l = 0; l < t.length; ++l)
          if ((a = t[l]) in o) {
            var c = o[a].base;
            (u -= e(Math.max(c.width, c.height))) <= 0
              ? ((c.textureIndex = 0),
                console.warn(
                  'setTexturePriority: Image "%s" was given textureIndex=0 because there is no available texture space (%s).',
                  a,
                  u
                ))
              : (c.textureIndex = 1 + (l % (n - 1))),
        ...
        return (
          (this.renderSession.maxTextureAvailableSpace = u),
          this.currentBatchedTextures
        );
      }
      console.warn(
        "setTexturePriority error: Multi Texture support hasn't been enabled in the Phaser Game Config."
      );
    }),
    ...
    (s.WebGLStencilManager.prototype.bindGraphics = function (t, e, i) {
      ...
      var s,
        ...
        o = i.offset;
      1 === e.mode
        ? ((s = i.shaderManager.complexPrimitiveShader),
    ...
    (s.WebGLShaderManager.prototype.setContext = function (t) {
      (this.gl = t),
        ...
        (this.creatureShader = s.CreatureShader
          ? new s.CreatureShader(t)
          : null),
    ...
    (s.WebGLSpriteBatch.prototype.flush = function () {
      if (0 !== this.currentBatchSize) {
        ...
        if (this.currentBatchSize > 0.5 * this.size)
          ...
          e.bindBuffer(e.ARRAY_BUFFER, this.vertexBuffer);
          var n = this.positions.subarray(
            0,
            this.currentBatchSize * this.vertexSize
          );
        ...
        for (
          var r,
            ...
            g = !1,
            m = 0,
            y = this.currentBatchSize;
          m < y;
          m++
        ) {
          (r = (h = this.sprites[m]).tilingTexture
            ? h.tilingTexture.baseTexture
            : h.texture.baseTexture),
            (f = d !== (o = h.blendMode)),
            (g = p !== (a = h.shader || this.defaultShader));
          var v = r.skipRender;
          if (
            (v && h.children.length > 0 && (v = !1),
            (f || g) &&
              ...
              (c = r),
              f &&
                ((d = o), this.renderSession.blendModeManager.setBlendMode(d)),
              g))
          ) {
            (t = (p = a).shaders[e.id]) ||
              (((t = new s.PixiShader(e)).fragmentSrc = p.fragmentSrc),
    ...
    (s.WebGLFilterManager.prototype.pushFilter = function (t) {
      ...
      (a.x -= h),
        ...
        e.viewport(
          0,
          0,
          a.width * this.renderSession.resolution,
          a.height * this.renderSession.resolution
        ),
        (i.x = a.width / 2),
        (i.y = -a.height / 2),
        (n.x = -a.x),
    ...
    (s.WebGLFilterManager.prototype.popFilter = function () {
      ...
      if (e.filterPasses.length > 1) {
        t.viewport(
          0,
          0,
          i.width * this.renderSession.resolution,
          i.height * this.renderSession.resolution
        ),
          t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffer),
    ...
    (s.WebGLFilterManager.prototype.applyFilterPass = function (t, e, i, n) {
      var r = this.gl,
        o = t.shaders[r.id];
      o ||
        (((o = new s.PixiShader(r)).fragmentSrc = t.fragmentSrc),
  ...
  return (
    (s.FilterTexture = function (t, i, n, r, o) {
    ...
    (s.CanvasTinter.tintWithPerPixel = function (t, e, i) {
      ...
      t.rotated && ((o = a), (a = r.width)),
        (i.width === o && i.height === a) || ((i.width = o), (i.height = a)),
        (n.globalCompositeOperation = "copy"),
        n.drawImage(t.baseTexture.source, r.x, r.y, o, a, 0, 0, o, a);
      for (
        var h = Phaser.Color.hexToRGBArray(e),
          u = h[0],
          l = h[1],
          c = h[2],
          d = n.getImageData(0, 0, o, a),
          p = d.data,
          f = 0;
        f < p.length;
        f += 4
      ...
      (this.width = t * this.resolution),
        ...
        this.renderSession.smoothProperty &&
          (this.context[this.renderSession.smoothProperty] =
            this.renderSession.scaleMode === s.scaleModes.LINEAR);
    }),
    ...
    (s.Texture = function (t, e, i, n) {
      (this.noFrame = !1),
        e || ((this.noFrame = !0), (e = new s.Rectangle(0, 0, 1, 1))),
        ...
        (this.rotated = !1),
        t.hasLoaded &&
          (this.noFrame && (e = new s.Rectangle(0, 0, t.width, t.height)),
          this.setFrame(e));
    }),
  ...
  function () {
    ...
    if (
      ...
      Array.prototype.forEach ||
        (Array.prototype.forEach = function (t) {
          ...
          for (
            var s = arguments.length >= 2 ? arguments[1] : void 0, n = 0;
            n < i;
            n++
          )
      ...
      "function" != typeof window.Uint32Array &&
        "object" != typeof window.Uint32Array)
    ) {
      var s = function (t) {
        var e = new Array();
        (window[t] = function (t) {
    ...
    window.console ||
      ...
      Object.assign ||
        (Object.assign = function (t, e) {
          ...
          for (
            var i = Object(t), s = Object.prototype.hasOwnProperty, n = 1;
            n < arguments.length;
            n++
          ) {
            var r = arguments[n];
          ...
          return (
            "string" == typeof t
              ? "%" === t.substr(-1)
                ? ((i = parseInt(t, 10) / 100),
                  (s =
                    0 === e ? window.innerWidth * i : window.innerHeight * i))
                : (s = parseInt(t, 10))
              : (s = t),
            s
          );
              ...
              for (e in t)
                (s = a[e]),
                  a !== (n = t[e]) &&
                    (l &&
                    n &&
                    (i.Utils.isPlainObject(n) || (r = Array.isArray(n)))
                      ? (r
                          ? ((r = !1), (o = s && Array.isArray(s) ? s : []))
                          : (o = s && i.Utils.isPlainObject(s) ? s : {}),
                        (a[e] = i.Utils.extend(l, o, n)))
                      : void 0 !== n && (a[e] = n));
          return a;
        },
        mixinPrototype: function (t, e, i) {
          ...
          for (var s = Object.keys(e), n = 0; n < s.length; n++) {
            var r = s[n],
              o = e[r];
            (!i && r in t) ||
              (!o || ("function" != typeof o.get && "function" != typeof o.set)
                ? (t[r] = o)
        ...
        mixin: function (t, e) {
          ...
          for (var s in t) {
            ...
            if (!n.childNodes && !n.cloneNode) {
              ...
              t[s] && "object" === r
                ? typeof e[s] === r
                  ? (e[s] = i.Utils.mixin(t[s], e[s]))
                  : (e[s] = i.Utils.mixin(t[s], new n.constructor()))
                : (e[s] = t[s]);
            }
          }
          return e;
      ...
      (i.Circle.prototype = {
        ...
        clone: function (t) {
          return (
            void 0 === t || null === t
              ? (t = new i.Circle(this.x, this.y, this.diameter))
      ...
      (i.Circle.contains = function (t, e, i) {
        return (
          ...
          i >= t.top &&
          i <= t.bottom &&
          (t.x - e) * (t.x - e) + (t.y - i) * (t.y - i) <= t.radius * t.radius
        );
      }),
      ...
      (i.Circle.intersectsLine = function (t, e, s) {
        var n = t.x,
          ...
          g = new i.Point(c, p),
          m = new i.Point(d, f),
          y = e.pointOnSegment(g.x, g.y, 0.01),
          v = e.pointOnSegment(m.x, m.y, 0.01);
        return y && v
          ? !s || [g, m]
          : y
          ? !s || [g]
      ...
      (i.Ellipse.prototype = {
        ...
        clone: function (t) {
          return (
            void 0 === t || null === t
              ? (t = new i.Ellipse(this.x, this.y, this.width, this.height))
      ...
      (i.Ellipse.contains = function (t, e, i) {
        ...
        var s = (e - t.x) / t.width - 0.5,
          n = (i - t.y) / t.height - 0.5;
        return (s *= s), (n *= n), s + n < 0.25;
      }),
      ...
      (i.Line.prototype = {
        ...
        fromSprite: function (t, e, i) {
          return (
            void 0 === i && (i = !1),
            i
              ? this.setTo(t.centerX, t.centerY, e.centerX, e.centerY)
              : this.fromPoints(t, e)
          );
        },
        ...
        rotate: function (t, e) {
          ...
          return (
            this.start.rotate(i, s, t, e), this.end.rotate(i, s, t, e), this
          );
        },
        rotateAround: function (t, e, i, s) {
          return (
            this.start.rotate(t, e, i, s), this.end.rotate(t, e, i, s), this
          );
        },
        ...
        pointOnSegment: function (t, e, i) {
          ...
          return (
            this.pointOnLine(t, e, i) && t >= s && t <= n && e >= r && e <= o
          );
        },
        random: function (t) {
          void 0 === t && (t = new i.Point());
      ...
      (i.Point.prototype = {
        ...
        clamp: function (t, e) {
          return (
            (this.x = i.Math.clamp(this.x, t, e)),
        ...
        clip: function (t) {
          var e = t.left,
            ...
            n = t.bottom;
          return (
            this.x < e ? (this.x = e) : this.x > s && (this.x = s),
      ...
      (i.Point.fuzzyEquals = function (t, e, s) {
        return (
          i.Math.fuzzyEquals(t.x, e.x, s) && i.Math.fuzzyEquals(t.y, e.y, s)
        );
      }),
      ...
      (i.Point.centroid = function (t, e) {
        ...
        if (s < 1)
          throw new Error(
            "Phaser.Point. Parameter 'points' array must not be empty"
          );
      ...
      (i.Point.sortClockwise = function (t, e) {
        ...
        return t.sort(function (t, e) {
          ...
          return n < 0
            ...
            : n > 0
            ? 1
            : (t.x - i) * (t.x - i) + (t.y - s) * (t.y - s) >
              (e.x - i) * (e.x - i) + (e.y - s) * (e.y - s)
            ? -1
            : 1;
        });
      }),
      ...
      (i.Polygon.prototype = {
        ...
        flatten: function () {
          return (
            (this._points = this.toNumberArray()), (this.flattened = !0), this
          );
        },
        clone: function (t) {
          var e = this._points.slice();
          return (
            void 0 === t || null === t ? (t = new i.Polygon(e)) : t.setTo(e), t
          );
        },
        contains: function (t, e) {
          var i = !1;
          if (this.flattened)
            for (
              var s = -2, n = this._points.length - 2;
              (s += 2) < this._points.length;
              n = s
            ) {
            ...
            for (
              var s = -1, n = this._points.length - 1;
      ...
      (i.Rectangle.prototype = {
        ...
        scale: function (t, e) {
          return (
            void 0 === e && (e = t), (this.width *= t), (this.height *= e), this
          );
        },
        centerOn: function (t, e) {
      ...
      (i.Rectangle.size = function (t, e) {
        return (
          void 0 === e || null === e
            ? (e = new i.Point(t.width, t.height))
      ...
      (i.Rectangle.clone = function (t, e) {
        return (
          void 0 === e || null === e
            ? (e = new i.Rectangle(t.x, t.y, t.width, t.height))
      ...
      (i.Rectangle.intersection = function (t, e, s) {
        return (
          void 0 === s && (s = new i.Rectangle()),
          i.Rectangle.intersects(t, e) &&
            ((s.x = Math.max(t.x, e.x)),
      ...
      (i.Rectangle.intersects = function (t, e) {
        return (
          !(t.width <= 0 || t.height <= 0 || e.width <= 0 || e.height <= 0) &&
          !(t.right < e.x || t.bottom < e.y || t.x > e.right || t.y > e.bottom)
        );
      }),
      ...
      (i.Camera.prototype = {
        boot: function () {
          (this.displayObject = this.game.world),
            ...
            i.Graphics &&
              i.Camera.ENABLE_FX &&
              ((this.fx = new i.Graphics(this.game)),
        ...
        follow: function (t, e, s, n) {
          ...
          switch (e) {
            case i.Camera.FOLLOW_PLATFORMER:
              var o = this.width / 8,
                a = this.height / 3;
              this.deadzone = new i.Rectangle(
                (this.width - o) / 2,
                (this.height - a) / 2 - 0.25 * a,
                o,
                a
              );
              break;
          ...
          return (
            ...
            !(!s && this._shake.duration > 0) &&
              ...
              (this._shake.horizontal =
                n === i.Camera.SHAKE_BOTH || n === i.Camera.SHAKE_HORIZONTAL),
              (this._shake.vertical =
                n === i.Camera.SHAKE_BOTH || n === i.Camera.SHAKE_VERTICAL),
              !0)
          );
        },
        ...
        checkBounds: function () {
          ...
          t <= this.bounds.x * this.scale.x
            ...
            i <= this.bounds.top * this.scale.y
              ...
              : s >= this.bounds.bottom * this.scale.y &&
                ((this.atLimit.y = !0),
      ...
      (i.StateManager.prototype = {
        ...
        add: function (t, e, s) {
          ...
          var n;
          return (
            e instanceof i.State
              ? (n = e)
              : "object" == typeof e
              ? ((n = e).game = this.game)
              : "function" == typeof e && (n = new e(this.game)),
            (this.states[t] = n),
            s &&
              (this.game.isBooted ? this.start(t) : (this._pendingState = t)),
            n
          );
        },
        remove: function (t) {
            ...
            (this._pendingState = null),
              this.onPreloadCallback
                ? (this.game.load.reset(!0),
                  ...
                  0 === this.game.load.totalQueuedPacks()
                    ? this.loadComplete()
        ...
        checkState: function (t) {
          var e = this.states[t];
          return e
            ? !!(e.preload || e.create || e.update || e.render) ||
                (console.warn(
                  "Invalid Phaser State object given. Must contain at least one of the required functions: preload, create, update or render"
                ),
                !1)
            : (console.warn(
                "Phaser.StateManager - No state found with the key: " + t
              ),
              !1);
        },
        link: function (t) {
      ...
      (i.Signal.prototype = {
        ...
        validateListener: function (t, e) {
          if ("function" != typeof t)
            throw new Error(
              "Phaser.Signal: listener is a required param of {fn}() and should be a Function.".replace(
                "{fn}",
                e
              )
            );
        ...
        _registerListener: function (t, e, s, n, r) {
          ...
          if (-1 !== a) {
            ...
            (o = new i.SignalBinding(this, t, e, s, n, r)), this._addBinding(o);
          return (
            this.memorize && this._prevParams && o.execute(this._prevParams), o
          );
        },
          ...
          ((this.uniforms = {
            ...
            date: {
              ...
              value: [
                ...
                n.getMonth(),
                n.getDate(),
                60 * n.getHours() * 60 + 60 * n.getMinutes() + n.getSeconds(),
              ],
            },
      ...
      (i.Stage.prototype = Object.create(
      ...
      (i.Stage.prototype.setBackgroundColor = function (t) {
        this.game.transparent ||
          (i.Color.valueToColor(t, this._bgColor),
      ...
      (i.Stage.prototype.add = function (t, e, i) {
        return t.parent === this
          ? t
          : (t.body && t.parent && t.parent.hash && t.parent.removeFromHash(t),
      ...
      (i.Group.prototype = Object.create(
        PIXI.DisplayObjectContainer.prototype
      )),
      ...
      (i.Group.prototype.create = function (t, e, i, s, n, r) {
        ...
        return (
          (o.exists = n), (o.visible = n), (o.alive = n), this.add(o, !1, r)
        );
      }),
      ...
      (i.Group.prototype.align = function (t, e, s, n, r, o) {
        if (
          ...
          return !1;
        for (
          var a = new i.Rectangle(0, 0, s, n), h = t * s, u = e * n, l = o;
          l < this.children.length;
          l++
        ) {
          var c = this.children[l];
          if (c.alignIn)
            if ((c.alignIn(a, r), -1 === t))
              (a.y += n), a.y === u && ((a.x += s), (a.y = 0));
            else if (-1 === e) (a.x += s), a.x === h && ((a.x = 0), (a.y += n));
            else if (
              ((a.x += s), a.x === h && ((a.x = 0), (a.y += n), a.y === u))
            )
              return !0;
        }
        return !0;
      ...
      (i.Group.prototype.hasProperty = function (t, e) {
        ...
        return (
          (1 === i && e[0] in t) ||
          (2 === i && e[0] in t && e[1] in t[e[0]]) ||
          (3 === i && e[0] in t && e[1] in t[e[0]] && e[2] in t[e[0]][e[1]]) ||
          (4 === i &&
            e[0] in t &&
            e[1] in t[e[0]] &&
            e[2] in t[e[0]][e[1]] &&
      ...
      (i.Group.prototype.setAll = function (t, e, i, s, n, r) {
        ...
        for (var o = 0; o < this.children.length; o++)
          (!i || (i && this.children[o].alive)) &&
            (!s || (s && this.children[o].visible)) &&
            this.setProperty(this.children[o], t, e, n, r);
      }),
      (i.Group.prototype.setAllChildren = function (t, e, s, n, r, o) {
        ...
        for (var a = 0; a < this.children.length; a++)
          (!s || (s && this.children[a].alive)) &&
            (!n || (n && this.children[a].visible)) &&
            (this.children[a] instanceof i.Group
              ? this.children[a].setAllChildren(t, e, s, n, r, o)
              : this.setProperty(this.children[a], t.split("."), e, r, o));
      }),
        ...
        if (void 0 !== t) {
          ...
          for (var r = null, o = null, a = 0; a < this.children.length; a++)
            (r = this.callbackFromArray(this.children[a], t, i)),
              e && r
                ? ((o = this.callbackFromArray(this.children[a], e, s)),
                  r && r.apply(o, n))
                : r && r.apply(this.children[a], n);
        }
      }),
      ...
      (i.Group.prototype.forEach = function (t, e, i) {
        if ((void 0 === i && (i = !1), arguments.length <= 3))
          ...
          for (n = 0; n < this.children.length; n++)
            (!i || (i && this.children[n].exists)) &&
              ((s[0] = this.children[n]), t.apply(e, s));
        }
      }),
      ...
      (i.Group.prototype.iterate = function (t, e, s, n, r, o) {
        ...
        return s === i.Group.RETURN_TOTAL
          ? a
          : s === i.Group.RETURN_ALL
          ? h
          : null;
      }),
      ...
      (i.Group.prototype.getClosestTo = function (t, e, s) {
        for (
          var n = Number.MAX_VALUE, r = 0, o = null, a = 0;
          a < this.children.length;
          a++
        ) {
          var h = this.children[a];
          h.exists &&
            (r = Math.abs(i.Point.distance(t, h))) < n &&
            (!e || e.call(s, h, r)) &&
            ((n = r), (o = h));
        }
        return o;
        ...
        return (
          ...
          1 === arguments.length && "object" == typeof arguments[0]
            ...
            : ((this.config = { enableDebug: !0 }),
              ...
              (this.rnd = new i.RandomDataGenerator([
      ...
      (i.Game.prototype = {
        ...
        boot: function () {
          this.isBooted ||
            ...
            this.config.enableDebug
              ? ((this.debug = new i.Utils.Debug(this)), this.debug.boot())
              : (this.debug = {
                  preUpdate: function () {},
                  update: function () {},
                  reset: function () {},
            ...
            this.config && this.config.forceSetTimeOut
              ? (this.raf = new i.RequestAnimationFrame(
                  this,
                  this.config.forceSetTimeOut
                ))
              : (this.raf = new i.RequestAnimationFrame(this, !1)),
            (this._kickstart = !0),
            window.focus &&
              (!window.PhaserGlobal ||
                (window.PhaserGlobal && !window.PhaserGlobal.stopFocus)) &&
              window.focus(),
            this.config.disableStart ||
              (this.cache.isReady
                ? this.raf.start()
          ...
          if (!window.PhaserGlobal || !window.PhaserGlobal.hideBanner) {
            ...
            if (
              (this.renderType === i.WEBGL
                ? ((e = "WebGL"), n++)
                : this.renderType === i.HEADLESS && (e = "Headless"),
              this.device.webAudio && ((s = "WebAudio"), n++),
              this.device.ie)
            )
              window.console &&
                console.log(
        ...
        setUpRenderer: function () {
          if (!this.device.canvas)
            throw new Error(
              "Phaser.Game - Cannot create Canvas 2d context, aborting."
            );
          if (
            (this.config.canvas
              ? (this.canvas = this.config.canvas)
              : (this.canvas = i.Canvas.create(
                  this,
                  this.width,
                  this.height,
            ...
            this.renderType === i.WEBGL ||
              this.renderType === i.WEBGL_MULTI ||
              (this.renderType === i.AUTO && this.device.webGL))
          ) {
            (this.multiTexture || this.renderType === i.WEBGL_MULTI) &&
              (PIXI.enableMultiTexture(), (this.multiTexture = !0));
            try {
          ...
          this.renderer ||
            ...
            this.device.cocoonJS &&
              (this.canvas.screencanvas = this.renderType === i.CANVAS),
            this.renderType !== i.HEADLESS &&
            ...
            if (this._spiraling > 1 && !this.forceSingleUpdate)
              this.time.time > this._nextFpsNotification &&
                ...
                this.dropFrames
                  ...
                  : (this.updateRender(
                      this.time.slowMotion * this.time.desiredFps
                    ),
                    (this.rendersThisFrame = 1));
            else {
              ...
              for (
                this.updatesThisFrame = Math.floor(this._deltaTime / e),
                  ...
                  this.forceSingleRender
                    ? (this.rendersThisFrame = 1)
                    : (this.rendersThisFrame = Math.min(
                        1,
                        this.updatesThisFrame
                      ));
                this._deltaTime >= e &&
      ...
      (i.Input.prototype = {
        boot: function () {
          (this.mousePointer = new i.Pointer(
            this.game,
            0,
            i.PointerMode.CURSOR
          )),
            this.addPointer(),
            this.addPointer(),
        ...
        addTouchLockCallback: function (t, e, i) {
          void 0 === i && (i = !1),
            this.touchLockCallbacks.push({ callback: t, context: e, onEnd: i });
        },
        ...
        executeTouchLockCallbacks: function (t, e) {
          for (var i = this.touchLockCallbacks.length; i--; ) {
            ...
            s.onEnd === t &&
              s.callback.call(s.context, this, e) &&
        ...
        addPointer: function () {
          if (this.pointers.length >= i.Input.MAX_POINTERS)
            return (
              console.warn(
                "Phaser.Input.addPointer: Maximum limit of " +
                  i.Input.MAX_POINTERS +
                  " pointers reached."
              ),
              null
            );
        ...
        hitTest: function (t, e, s) {
          ...
          if (i.Creature && t instanceof i.Creature) {
            var n = Math.abs(t.width),
              ...
              o = t.x - n * t.anchorX;
            if (
              this.game.camera.x + e.x >= o &&
              this.game.camera.x + e.x < o + n
            ) {
              a = t.y - r * t.anchorY;
              if (
                this.game.camera.y + e.y >= a &&
                this.game.camera.y + e.y < a + r
              )
                return !0;
            }
            ...
            for (u = 0; u < t.graphicsData.length; u++) {
              ...
              if (
                h.fill &&
                h.shape &&
                h.shape.contains(this._localPoint.x, this._localPoint.y)
              )
                return !0;
            }
      ...
      (i.Mouse.prototype = {
        start: function () {
          if (
            ...
            s &&
              (i.addEventListener(s, this._onMouseWheel, !0),
              "mousewheel" === s
                ? (this._wheelEvent = new t(-0.025, 1))
                : "DOMMouseScroll" === s && (this._wheelEvent = new t(1, 1)));
          }
        },
        ...
        onMouseOut: function (t) {
          (this.event = t),
            ...
            this.input.enabled &&
              ...
              (this.stopOnGameOut &&
                ((t.identifier = 0), this.input.mousePointer.stop(t)),
              this.input.interactiveItems.callAll(
                "_pointerOutHandler",
      ...
      Object.defineProperties(t.prototype, {
        ...
        deltaY: {
          get: function () {
            return (
              this._scaleFactor *
                (this.originalEvent.wheelDelta || this.originalEvent.detail) ||
              0
            );
          },
        },
      ...
      (i.DeviceButton.prototype = {
        ...
        justReleased: function (t) {
          return (
            (t = t || 250), this.isUp && this.timeUp + t > this.game.time.time
          );
        },
        reset: function () {
          (this.isDown = !1),
      ...
      (i.Pointer = function (t, e, s) {
        (this.game = t),
          ...
          (this.pointerId = null),
          (this.pointerMode =
            s || i.PointerMode.CURSOR | i.PointerMode.CONTACT),
          (this.target = null),
          (this.button = null),
          (this.leftButton = new i.DeviceButton(this, i.Pointer.LEFT_BUTTON)),
          (this.middleButton = new i.DeviceButton(
            this,
            i.Pointer.MIDDLE_BUTTON
          )),
          ...
          (this.forwardButton = new i.DeviceButton(
            this,
            i.Pointer.FORWARD_BUTTON
          )),
          (this.eraserButton = new i.DeviceButton(
            this,
            i.Pointer.ERASER_BUTTON
          )),
          (this._holdSent = !1),
          (this._history = []),
          (this._nextDrop = 0),
      ...
      (i.Pointer.prototype = {
        ...
        processButtonsUpDown: function (t, e) {
          ...
          void 0 !== t
            ? (s && 1 === t && e.ctrlKey && (t = 2),
              ...
              this.eraserButton.startStop(i.Pointer.ERASER_BUTTON & t, e))
            : void 0 !== e.button
            ? s && e.ctrlKey && 0 === e.button
              ? this.rightButton.start(e)
              : s
              ? this.processButtonsDown(e.button, e)
              : n || this.processButtonsUp(e.button, e)
            : s
            ? e.ctrlKey
              ? this.rightButton.start(e)
              : this.leftButton.start(e)
            : (this.leftButton.stop(e), this.rightButton.stop(e));
        },
        ...
        start: function (t) {
          ...
          return (
            ...
            (e.multiInputOverride === i.Input.MOUSE_OVERRIDES_TOUCH ||
              e.multiInputOverride === i.Input.MOUSE_TOUCH_COMBINE ||
              (e.multiInputOverride === i.Input.TOUCH_OVERRIDES_MOUSE &&
                0 === e.totalActivePointers)) &&
              ((e.x = this.x),
              (e.y = this.y),
        ...
        update: function () {
          ...
          this.active &&
            ...
            !1 === this._holdSent &&
              ...
              ((t.multiInputOverride === i.Input.MOUSE_OVERRIDES_TOUCH ||
                t.multiInputOverride === i.Input.MOUSE_TOUCH_COMBINE ||
                (t.multiInputOverride === i.Input.TOUCH_OVERRIDES_MOUSE &&
                  0 === t.totalActivePointers)) &&
        ...
        move: function (t, e) {
          ...
          if (!s.pollLocked) {
            void 0 === e && (e = !1),
              ...
              (s.multiInputOverride === i.Input.MOUSE_OVERRIDES_TOUCH ||
                s.multiInputOverride === i.Input.MOUSE_TOUCH_COMBINE ||
                (s.multiInputOverride === i.Input.TOUCH_OVERRIDES_MOUSE &&
                  0 === s.totalActivePointers)) &&
                ((s.activePointer = this),
                (s.x = this.x),
                (s.y = this.y),
            ...
            for (var n = s.moveCallbacks.length; n--; )
              s.moveCallbacks[n].callback.call(
                s.moveCallbacks[n].context,
                this,
                this.x,
                this.y,
                e
            ...
            return (
              null === this.targetObject ||
              (this.game.paused && !this.targetObject.noPause) ||
              !0 !== this.targetObject.isDragged
                ? s.interactiveItems.total > 0 &&
        ...
        processInteractiveObjects: function (t) {
          ...
          for (this.interactiveCandidates = []; n; )
            (n.checked = !1),
              !n.validForInput(i, e, !1) ||
                (this.game.paused && !n.sprite.noPause) ||
                ((n.checked = !0),
                ((t && n.checkPointerDown(this, !0)) ||
                  (!t && n.checkPointerOver(this, !0))) &&
          ...
          for (n = this.game.input.interactiveItems.first; n; )
            !n.checked &&
              n.validForInput(i, e, !0) &&
              ((t && n.checkPointerDown(this, !1)) ||
                (!t && n.checkPointerOver(this, !1))) &&
              ((e = n.sprite.renderOrderID),
              (i = n.priorityID),
              (s = n),
              this.interactiveCandidates.push(n)),
          ...
          return (
            this.game.input.customCandidateHandler &&
              (s = this.game.input.customCandidateHandler.call(
        ...
        addClickTrampoline: function (t, e, i, s) {
          if (this.isDown) {
            for (
              var n = (this._clickTrampolines = this._clickTrampolines || []),
                r = 0;
              r < n.length;
              r++
            )
      ...
      (i.PointerMode = { CURSOR: 1, CONTACT: 2 }),
      (i.Touch = function (t) {
        (this.game = t),
          (this.enabled = !0),
          (this.callbackContext = this.game),
      ...
      (i.InputHandler.prototype = {
        ...
        checkPointerDown: function (t, e) {
          return (
            !!(
              ...
              0 !== this.sprite.worldScale.x &&
              0 !== this.sprite.worldScale.y
            ) &&
          ...
          if (null !== this.sprite) {
            ...
            if (!1 === i.isOver || t.dirty) {
              ...
              (i.isOver = !0),
                ...
                this.sprite.parent &&
                  this.sprite.parent.onChildInputOver &&
          ...
          if (null !== this.sprite) {
            ...
            (i.isOver = !1),
              ...
              !e &&
                ...
                this.sprite &&
                  this.sprite.parent &&
                  this.sprite.parent.onChildInputOut &&
            ...
            if (!e.isDown && e.isOver) {
              ...
              if (
                ...
                this.sprite &&
                  ...
                  this.sprite &&
                    this.sprite.parent &&
                    this.sprite.parent.onChildInputDown &&
          ...
          if (null !== this.sprite) {
            ...
            if (e.isDown && t.isUp) {
              ...
              this.sprite &&
                ...
                this.sprite &&
                  this.sprite.parent &&
                  this.sprite.parent.onChildInputUp &&
        ...
        updateDrag: function (t, e) {
          ...
          if (this.sprite.fixedToCamera)
            var s =
                this.game.camera.scale.x * i.x +
                this._dragPoint.x +
                this.dragOffset.x,
              n =
                this.game.camera.scale.y * i.y +
                this._dragPoint.y +
                this.dragOffset.y;
          else
          ...
          if (this.sprite.fixedToCamera)
            this.allowHorizontalDrag &&
              (this.sprite.cameraOffset.x = s - this.game.camera.x),
              this.allowVerticalDrag &&
                (this.sprite.cameraOffset.y = n - this.game.camera.y),
        ...
        startDrag: function (t) {
          ...
          if (
            ...
            if (this.dragFromCenter) {
              ...
              (this.sprite.cameraOffset.x =
                n.x + (this.sprite.cameraOffset.x - o.x)),
                (this.sprite.cameraOffset.y =
                  n.y + (this.sprite.cameraOffset.y - o.y));
            }
        ...
        globalToLocal: function (t) {
          return this.sprite.parent
            ? this.game.input.getLocalPosition(this.sprite.parent, {
                x: t.x,
                y: t.y,
              })
            : t;
      ...
      (i.Keyboard.prototype = {
        ...
        addKey: function (t) {
          return (
            this._keys[t] ||
              ((this._keys[t] = new i.Key(this.game, t)),
      ...
      Object.defineProperty(i.Keyboard.prototype, "lastChar", {
        get: function () {
          return this.event && 32 === this.event.charCode
            ? ""
            : this.pressEvent
    ...
    for (var n in i.KeyCode)
      i.KeyCode.hasOwnProperty(n) &&
        !n.match(/[a-z]/) &&
        (i.Keyboard[n] = i.KeyCode[n]);
    (i.Component = function () {}),
      ...
      (i.Component.Bounds.prototype = {
        ...
        alignIn: function (t, e, s, n) {
          switch ((void 0 === s && (s = 0), void 0 === n && (n = 0), e)) {
            default:
            case i.TOP_LEFT:
              (this.left = t.left - s), (this.top = t.top - n);
              break;
            case i.TOP_CENTER:
        ...
        alignTo: function (t, e, s, n) {
          switch ((void 0 === s && (s = 0), void 0 === n && (n = 0), e)) {
            default:
            case i.TOP_LEFT:
              (this.left = t.left - s), (this.bottom = t.top - n);
              break;
            case i.TOP_CENTER:
      ...
      (i.Component.Core.init = function (t, e, s, n, r) {
        if (!i.Component.Core.skipTypeChecks) {
          if (!(t instanceof i.Game))
            throw new Error(
              "The value passed as the `game` argument (" +
                t +
                ") is not an instance of Phaser.Game."
            );
          "number" != typeof e &&
            (console.warn("The `x` argument value (%s) should be a number.", e),
            (e = 0)),
            "number" != typeof s &&
              (console.warn(
                "The `y` argument value (%s) should be a number.",
                s
              ),
              (s = 0));
        }
        (this.game = t),
          ...
          this.components.FixedToCamera &&
            (this.cameraOffset = new i.Point(e, s));
      }),
      ...
      (i.Component.Crop.prototype = {
        ...
        crop: function (t, e) {
          void 0 === e && (e = !1),
            t
              ? (e && null !== this.cropRect
                  ? this.cropRect.setTo(t.x, t.y, t.width, t.height)
                  : e && null === this.cropRect
                  ? (this.cropRect = new i.Rectangle(
                      t.x,
                      t.y,
                      t.width,
                      t.height
        ...
        destroy: function (t, e) {
          if (null !== this.game && !this.destroyPhase) {
            void 0 === t && (t = !0),
              ...
              this.parent &&
                (this.parent instanceof i.Group
    ...
    for (var r in i.Events.prototype)
      i.Events.prototype.hasOwnProperty(r) &&
        0 === r.indexOf("on") &&
        null === i.Events.prototype[r] &&
        (function (t, e) {
          "use strict";
    ...
    (i.Component.FixedToCamera = function () {}),
      ...
      (i.Component.Health.prototype = {
        ...
        damage: function (t) {
          return (
            this.alive && ((this.health -= t), this.health <= 0 && this.kill()),
            this
          );
        },
      ...
      (i.Component.InputEnabled.prototype = {
        ...
        inputEnabled: {
          ...
          set: function (t) {
            t
              ? null === this.input
                ? ((this.input = new i.InputHandler(this)), this.input.start())
        ...
        if (this.autoCull || this.checkWorldBounds) {
          if (
            ...
            if (this.game.world.camera.view.intersects(this._bounds))
              (this.renderable = !0), this.game.world.camera.totalInView++;
      ...
      (i.Component.LoadTexture.prototype = {
        ...
        loadTexture: function (t, e, s) {
          t === i.PENDING_ATLAS ? ((t = e), (e = 0)) : (e = e || 0),
          ...
          if (i.RenderTexture && t instanceof i.RenderTexture)
            (this.key = t.key), this.setTexture(t);
          else if (i.BitmapData && t instanceof i.BitmapData)
            (this.customRender = !0),
              this.setTexture(t.texture),
              (r = n.hasFrameData(t.key, i.Cache.BITMAPDATA)
                ? !this.animations.loadFrameData(
                    n.getFrameData(t.key, i.Cache.BITMAPDATA),
                    e
                  )
        ...
        setFrame: function (t) {
          (this._frame = t),
            ...
            t.trimmed
              ...
              : !t.trimmed && this.texture.trim && (this.texture.trim = null),
        ...
        setScaleMinMax: function (t, e, s, n) {
          void 0 === e
            ...
            null === t
              ...
              : (this.scaleMin = new i.Point(t, e)),
            null === s
              ? (this.scaleMax = null)
              : this.scaleMax
              ? this.scaleMax.set(s, n)
              : (this.scaleMax = new i.Point(s, n)),
            null === this.scaleMin
              ? (this.transformCallback = null)
      ...
      (i.GameObjectFactory.prototype = {
        ...
        emitter: function (t, e, s) {
          return this.game.particles.add(
            new i.Particles.Arcade.Emitter(this.game, t, e, s)
          );
        },
      ...
      i.Component.Core.install.call(i.Sprite.prototype, [
        "Angle",
        "Animation",
        "AutoCull",
        "Bounds",
      ...
      i.Component.Core.install.call(i.Image.prototype, [
        "Angle",
        "Animation",
        "AutoCull",
        "Bounds",
      ...
      (i.Image.prototype.preUpdate = function () {
        return (
          !(!this.preUpdateInWorld() || !this.preUpdateLifeSpan()) &&
          this.preUpdateCore()
        );
      }),
    ...
    return (
      ...
      (i.Button.prototype.setStateFrame = function (t, e, i) {
        var s = "_on" + t + "Frame";
        null !== e
          ? ((this[s] = e), i && this.changeStateFrame(t))
          : (this[s] = null);
      }),
      (i.Button.prototype.changeStateFrame = function (t) {
        ...
        return "string" == typeof e
          ? ((this.frameName = e), !0)
          : "number" == typeof e && ((this.frame = e), !0);
      }),
      ...
      (i.Button.prototype.setStateSound = function (t, e, s) {
        var n = "on" + t + "Sound",
          r = "on" + t + "SoundMarker";
        e instanceof i.Sound || e instanceof i.AudioSprite
          ? ((this[n] = e), (this[r] = "string" == typeof s ? s : ""))
          : ((this[n] = null), (this[r] = ""));
      }),
      ...
      (i.Button.prototype.onInputOverHandler = function (t, e) {
        (e.justReleased() &&
          (this.justReleasedPreventsOver & e.pointerMode) === e.pointerMode) ||
      ...
      (i.SpriteBatch.prototype._renderWebGL = function (t) {
        !this.visible ||
          ...
          !this.children.length ||
          (this.ready ||
            ((this.fastSpriteBatch = new PIXI.WebGLFastSpriteBatch(t.gl)),
            (this.ready = !0)),
      ...
      (i.SpriteBatch.prototype._renderCanvas = function (t) {
        if (this.visible && !(this.alpha <= 0) && this.children.length) {
          ...
          for (
            var i = this.worldTransform, s = !0, n = 0;
            ...
            if (r.visible) {
              var o = r.texture,
                a = o.frame;
              if (
                ((e.globalAlpha = this.worldAlpha * r.alpha),
                r.rotation % (2 * Math.PI) == 0)
              )
                s && (e.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty), (s = !1)),
                  e.drawImage(
                    ...
                    a.width,
                    a.height,
                    (r.anchor.x * (-a.width * r.scale.x) +
                      r.position.x +
                      0.5 +
                      t.shakeX) |
                      0,
                    (r.anchor.y * (-a.height * r.scale.y) +
                      r.position.y +
                      0.5 +
                      t.shakeY) |
                      0,
                ...
                t.roundPixels
                  ? e.setTransform(h.a, h.b, h.c, h.d, 0 | u, 0 | l)
                  : e.setTransform(h.a, h.b, h.c, h.d, u, l),
                  e.drawImage(
                    o.baseTexture.source,
                    a.x,
                    a.y,
                    a.width,
                    a.height,
                    (r.anchor.x * -a.width + 0.5) | 0,
                    (r.anchor.y * -a.height + 0.5) | 0,
                    a.width,
                    a.height
                  );
              }
      ...
      (i.BitmapData = function (t, e, s, n, r) {
        (void 0 !== s && 0 !== s) || (s = 256),
          ...
          (this.smoothProperty =
            t.renderType === i.CANVAS
              ? t.renderer.renderSession.smoothProperty
              : i.Canvas.getSmoothingPrefix(this.context)),
          ...
          (this.textureFrame = this.frameData.addFrame(
            new i.Frame(0, 0, 0, s, n, "bitmapData")
          )),
      ...
      (i.BitmapData.prototype = {
        ...
        moveH: function (t, e) {
          void 0 === e && (e = !0),
            void 0 === this._swapCanvas &&
              (this._swapCanvas = i.CanvasPool.create(
                this,
                this.width,
                this.height
              ));
        ...
        load: function (t) {
          if (("string" == typeof t && (t = this.game.cache.getImage(t)), t))
            return (
        ...
        resize: function (t, e) {
          return (
            (t === this.width && e === this.height) ||
              ...
              (this.canvas.height = e),
              void 0 !== this._swapCanvas &&
                ((this._swapCanvas.width = t), (this._swapCanvas.height = e)),
            ...
            for (var p = s; p < a; p++)
              i.Color.unpackPixel(this.getPixel32(p, d), u),
                !1 !== (l = t.call(e, u, p, d)) &&
                  null !== l &&
                  void 0 !== l &&
                  (this.setPixel32(p, d, l.r, l.g, l.b, l.a, !1), (c = !0));
          return (
            c &&
        ...
        processPixel: function (t, e, i, s, n, r) {
          ...
          for (
            var o = i + n, a = s + r, h = 0, u = 0, l = !1, c = s;
            c < a;
            c++
          )
            for (var d = i; d < o; d++)
              (h = this.getPixel32(d, c)),
                (u = t.call(e, h, d, c)) !== h &&
                  ((this.pixels[c * this.width + d] = u), (l = !0));
          return (
            l &&
              (this.context.putImageData(this.imageData, 0, 0),
              (this.dirty = !0)),
        ...
        replaceRGB: function (t, e, s, n, r, o, a, h, u) {
          ...
          void 0 !== u &&
            u instanceof i.Rectangle &&
            ((l = u.x), (c = u.y), (d = u.width), (p = u.height));
          for (var g = 0; g < p; g++)
            for (var m = 0; m < d; m++)
              this.getPixel32(l + m, c + g) === f &&
                this.setPixel32(l + m, c + g, r, o, a, h, !1);
          return (
            this.context.putImageData(this.imageData, 0, 0),
            (this.dirty = !0),
            this
        ...
        setHSL: function (t, e, s, n) {
          ...
          if (r || o || a) {
            void 0 === n &&
              (n = new i.Rectangle(0, 0, this.width, this.height));
        ...
        getFirstPixel: function (t) {
          ...
          1 === t
            ? ((r = -1), (n = this.height))
            : 3 === t && ((r = -1), (s = this.width));
          do {
            i.Color.unpackPixel(this.getPixel32(s, n), e),
              0 === t || 1 === t
                ? ++s === this.width &&
                  ((s = 0), ((n += r) >= this.height || n <= 0) && (o = !0))
                : (2 !== t && 3 !== t) ||
                  (++n === this.height &&
                    ((n = 0), ((s += r) >= this.width || s <= 0) && (o = !0)));
          } while (0 === e.a && !o);
          return (e.x = s), (e.y = n), e;
        },
        getBounds: function (t) {
          return (
            void 0 === t && (t = new i.Rectangle()),
        ...
        copy: function (t, e, s, n, r, o, a, h, u, l, c, d, p, f, g, m, y) {
          if (
            ((void 0 !== t && null !== t) || (t = this),
            t instanceof i.RenderTexture && (t = t.getCanvas()),
            (this._image = t),
            t instanceof i.Sprite ||
            ...
            this._pos.set(t.texture.crop.x, t.texture.crop.y),
              ...
              t.texture instanceof i.RenderTexture
        ...
        copyTransform: function (t, e, s) {
          ...
          var a = this.context;
          return (
            (this._alpha.prev = a.globalAlpha),
            a.save(),
            (a.globalAlpha = this._alpha.current),
            e && (this.op = e),
            (a[this.smoothProperty] =
        ...
        drawGroupProxy: function (t, e, s) {
          if (
            (t.hasOwnProperty("texture") && this.copyTransform(t, e, s),
        ...
        rect: function (t, e, i, s, n) {
          return (
            void 0 !== n && (this.context.fillStyle = n),
        ...
        textureLine: function (t, e, s) {
          if (
            ...
            var r = this.context;
            return (
              (r.fillStyle = r.createPattern(e, s)),
      ...
      (i.EarCut.Triangulate = function (t, e, s) {
        ...
        var h, u, l, c, d, p, f;
        if (
          (n && (o = i.EarCut.eliminateHoles(t, e, o, s)), t.length > 80 * s)
        ) {
          (h = l = t[0]), (u = c = t[1]);
          for (var g = s; g < r; g += s)
            (d = t[g]),
      ...
      (i.EarCut.linkedList = function (t, e, s, n, r) {
        var o,
          ...
          h,
          u = 0;
        for (o = e, a = s - n; o < s; o += n)
          (u += (t[a] - t[o]) * (t[o + 1] + t[a + 1])), (a = o);
        if (r === u > 0)
          for (o = e; o < s; o += n)
      ...
      (i.EarCut.filterPoints = function (t, e) {
        ...
        do {
          if (
            ((s = !1),
            n.steiner ||
              (!i.EarCut.equals(n, n.next) &&
                0 !== i.EarCut.area(n.prev, n, n.next)))
          )
            n = n.next;
          else {
            if ((i.EarCut.removeNode(n), (n = e = n.prev) === n.next))
              return null;
            s = !0;
          }
        } while (s || n !== e);
        ...
        if (t) {
          ...
          for (var h, u, l = t; t.prev !== t.next; )
            if (
              ...
              a
                ? 1 === a
                  ? ((t = i.EarCut.cureLocalIntersections(t, e, s)),
                    i.EarCut.earcutLinked(t, e, s, n, r, o, 2))
                  : 2 === a && i.EarCut.splitEarcut(t, e, s, n, r, o)
                : i.EarCut.earcutLinked(
                    i.EarCut.filterPoints(t),
                    e,
                    s,
                    n,
                    r,
      ...
      (i.EarCut.isEar = function (t) {
        ...
        for (var r = t.next.next; r !== t.prev; ) {
          if (
            i.EarCut.pointInTriangle(e.x, e.y, s.x, s.y, n.x, n.y, r.x, r.y) &&
            i.EarCut.area(r.prev, r, r.next) >= 0
          )
            return !1;
          r = r.next;
        }
      ...
      (i.EarCut.isEarHashed = function (t, e, s, n) {
        ...
        for (
          var h = r.x < o.x ? (r.x < a.x ? r.x : a.x) : o.x < a.x ? o.x : a.x,
            ...
            d = i.EarCut.zOrder(h, u, e, s, n),
            p = i.EarCut.zOrder(l, c, e, s, n),
            f = t.nextZ;
          f && f.z <= p;
          ...
          if (
            f !== t.prev &&
            f !== t.next &&
            i.EarCut.pointInTriangle(r.x, r.y, o.x, o.y, a.x, a.y, f.x, f.y) &&
            i.EarCut.area(f.prev, f, f.next) >= 0
          )
            return !1;
          f = f.nextZ;
        }
      ...
      (i.EarCut.cureLocalIntersections = function (t, e, s) {
        ...
        do {
          var r = n.prev,
            o = n.next.next;
          i.EarCut.intersects(r, n, n.next, o) &&
            i.EarCut.locallyInside(r, o) &&
            i.EarCut.locallyInside(o, r) &&
            (e.push(r.i / s),
            e.push(n.i / s),
            e.push(o.i / s),
        ...
        do {
          for (var h = a.next.next; h !== a.prev; ) {
            if (a.i !== h.i && i.EarCut.isValidDiagonal(a, h)) {
              ...
              return (
                (a = i.EarCut.filterPoints(a, a.next)),
      ...
      (i.EarCut.eliminateHoles = function (t, e, s, n) {
        ...
        for (r = 0, o = e.length; r < o; r++)
          (a = e[r] * n),
            ...
            (u = i.EarCut.linkedList(t, a, h, n, !1)) === u.next &&
              (u.steiner = !0),
      ...
      (i.EarCut.findHoleBridge = function (t, e) {
        ...
        for (n = s.next; n !== l; )
          r >= n.x &&
            ...
            ((u = Math.abs(o - n.y) / (r - n.x)) < c ||
              (u === c && n.x > s.x)) &&
            i.EarCut.locallyInside(n, t) &&
            ((s = n), (c = u)),
            (n = n.next);
        return s;
      }),
      ...
      (i.EarCut.isValidDiagonal = function (t, e) {
        return (
          ...
          (t.next.i !== e.i &&
            t.prev.i !== e.i &&
            !i.EarCut.intersectsPolygon(t, e) &&
            i.EarCut.locallyInside(t, e) &&
            i.EarCut.locallyInside(e, t) &&
            i.EarCut.middleInside(t, e))
        );
      }),
      ...
      (i.EarCut.intersects = function (t, e, s, n) {
        return (
          i.EarCut.area(t, e, s) > 0 != i.EarCut.area(t, e, n) > 0 &&
          i.EarCut.area(s, n, t) > 0 != i.EarCut.area(s, n, e) > 0
        );
      }),
      (i.EarCut.intersectsPolygon = function (t, e) {
        ...
        do {
          if (
            ...
            s.i !== e.i &&
            s.next.i !== e.i &&
            i.EarCut.intersects(s, s.next, t, e)
          )
            return !0;
          s = s.next;
        } while (s !== t);
      ...
      (i.EarCut.locallyInside = function (t, e) {
        return i.EarCut.area(t.prev, t, t.next) < 0
          ? i.EarCut.area(t, e, t.next) >= 0 && i.EarCut.area(t, t.prev, e) >= 0
          : i.EarCut.area(t, e, t.prev) < 0 || i.EarCut.area(t, t.next, e) < 0;
      }),
            ...
            1 === h.data[u].mode
              ? ((s = h.data[u]),
                ...
                n.drawElements(
                  ...
                  4,
                  n.UNSIGNED_SHORT,
                  2 * (s.indices.length - 4)
                ),
                e.stencilManager.popStencil(t, s, e))
              : ((s = h.data[u]),
      ...
      (PIXI.WebGLGraphics.updateGraphics = function (t, e) {
        var s = t._webGL[e.id];
        s || (s = t._webGL[e.id] = { lastIndex: 0, data: [], gl: e }),
          (t.dirty = !1);
        var n;
        if (t.clearDirty) {
        ...
        for (n = s.lastIndex; n < t.graphicsData.length; n++) {
          ...
          a.type === i.POLYGON
            ? ((a.points = a.shape.points.slice()),
              ...
              a.fill &&
                a.points.length >= PIXI.WebGLGraphics.stencilBufferLimit &&
                (a.points.length < 2 * PIXI.WebGLGraphics.stencilBufferLimit
                  ? ((o = PIXI.WebGLGraphics.switchMode(s, 0)),
                    PIXI.WebGLGraphics.buildPoly(a, o) ||
                      ((o = PIXI.WebGLGraphics.switchMode(s, 1)),
                      PIXI.WebGLGraphics.buildComplexPoly(a, o)))
                  : ((o = PIXI.WebGLGraphics.switchMode(s, 1)),
                    PIXI.WebGLGraphics.buildComplexPoly(a, o))),
              a.lineWidth > 0 &&
                ((o = PIXI.WebGLGraphics.switchMode(s, 0)),
                PIXI.WebGLGraphics.buildLine(a, o)))
            : ((o = PIXI.WebGLGraphics.switchMode(s, 0)),
              a.type === i.RECTANGLE
                ? PIXI.WebGLGraphics.buildRectangle(a, o)
                : a.type === i.CIRCLE || a.type === i.ELLIPSE
                ? PIXI.WebGLGraphics.buildCircle(a, o)
                : a.type === i.ROUNDEDRECTANGLE &&
                  PIXI.WebGLGraphics.buildRoundedRectangle(a, o)),
            s.lastIndex++;
        }
      ...
      (PIXI.WebGLGraphics.switchMode = function (t, e) {
        ...
        return (
          t.data.length
            ? ((i = t.data[t.data.length - 1]).mode === e && 1 !== e) ||
              (((i =
                PIXI.WebGLGraphics.graphicsDataPool.pop() ||
                new PIXI.WebGLGraphicsData(t.gl)).mode = e),
              t.data.push(i))
            : (((i =
                PIXI.WebGLGraphics.graphicsDataPool.pop() ||
                new PIXI.WebGLGraphicsData(t.gl)).mode = e),
      ...
      (PIXI.WebGLGraphics.buildRoundedRectangle = function (t, e) {
        ...
        if (
          (u.push(n, r + h),
          (u = u.concat(
            PIXI.WebGLGraphics.quadraticBezierCurve(
              n,
              r + a - h,
              n,
              r + a,
          ...
          (u = u.concat(
            PIXI.WebGLGraphics.quadraticBezierCurve(n + h, r, n, r, n, r + h)
          )),
          t.fill)
        ) {
      ...
      (PIXI.WebGLGraphics.buildLine = function (t, e) {
        ...
        if (0 !== n.length) {
          ...
          if (r.x === o.x && r.y === o.y) {
            (n = n.slice()).pop(), n.pop();
            var a =
                (o = new PIXI.Point(n[n.length - 2], n[n.length - 1])).x +
                0.5 * (r.x - o.x),
              h = o.y + 0.5 * (r.y - o.y);
      ...
      (PIXI.WebGLGraphics.buildComplexPoly = function (t, e) {
        ...
        if (!(s.length < 6)) {
          ...
          for (
            var r, o, a = 1 / 0, h = -1 / 0, u = 1 / 0, l = -1 / 0, c = 0;
            c < s.length;
            c += 2
          )
            (r = s[c]),
      ...
      (i.Graphics.prototype = Object.create(
        PIXI.DisplayObjectContainer.prototype
      )),
      (i.Graphics.prototype.constructor = i.Graphics),
      i.Component.Core.install.call(i.Graphics.prototype, [
        "Angle",
        "AutoCull",
        "Bounds",
        "Destroy",
      ...
      (i.Graphics.prototype.preUpdatePhysics =
        i.Component.PhysicsBody.preUpdate),
      ...
      (i.Graphics.prototype.postUpdate = function () {
        i.Component.PhysicsBody.postUpdate.call(this),
          i.Component.FixedToCamera.postUpdate.call(this),
          this._boundsDirty &&
            (this.updateLocalBounds(), (this._boundsDirty = !1));
        for (var t = 0; t < this.children.length; t++)
          this.children[t].postUpdate();
      }),
        ...
        return (
          ...
          this.currentPath &&
            (this.currentPath.shape.points.length
              ? this.drawShape(
                  new i.Polygon(this.currentPath.shape.points.slice(-2))
                )
      ...
      (i.Graphics.prototype.quadraticCurveTo = function (t, e, i, s) {
        ...
        for (
          var a = o[o.length - 2], h = o[o.length - 1], u = 0, l = 1;
          l <= 20;
          ++l
        )
          (n = a + (t - a) * (u = l / 20)),
      ...
      (i.Graphics.prototype.bezierCurveTo = function (t, e, i, s, n, r) {
        ...
        for (
          ...
          (h = (a = (o = 1 - (f = g / 20)) * o) * o),
            (l = (u = f * f) * f),
            c.push(
              h * d + 3 * a * f * t + 3 * o * u * i + l * n,
              h * p + 3 * a * f * e + 3 * o * u * s + l * r
            );
        return (this.dirty = !0), (this._boundsDirty = !0), this;
      }),
        ...
        if (this.graphicsData.length)
          for (var r, o, a, h, u, l, c = 0; c < this.graphicsData.length; c++) {
            var d = this.graphicsData[c],
              p = d.type,
              f = d.lineWidth;
            if (((r = d.shape), p === i.RECTANGLE || p === i.ROUNDEDRECTANGLE))
              (a = r.x - f / 2),
                (h = r.y - f / 2),
                (u = r.width + f),
                (l = r.height + f),
              ...
              for (var g = 0; g < o.length; g++)
                o[g] instanceof i.Point
                  ? ((a = o[g].x), (h = o[g].y))
                  : ((a = o[g]), (h = o[g + 1]), g < o.length - 1 && g++),
                  (t = a - f < t ? a - f : t),
                  (e = a + f > e ? a + f : e),
                  (s = h - f < s ? h - f : s),
                  (n = h + f > n ? h + f : n);
      ...
      (i.RenderTexture = function (t, e, s, n, r, o, a, h) {
        if (
          ...
          (this.baseTexture.textureIndex = h),
            ...
            (this.textureBuffer = new PIXI.FilterTexture(
              u,
              this.width,
              this.height,
      ...
      (i.RenderTexture.prototype.renderXY = function (t, e, s, n) {
        t.updateTransform(),
          ...
          this.renderer.type === i.WEBGL
            ? this._renderWebGL(t, this._tempMatrix, n)
            : this._renderCanvas(t, this._tempMatrix, n);
      }),
      ...
      (i.RenderTexture.prototype.render = function (t, e, s) {
        void 0 === e || null === e
          ...
          this.renderer.type === i.WEBGL
            ? this._renderWebGL(t, this._tempMatrix, s)
            : this._renderCanvas(t, this._tempMatrix, s);
      }),
      ...
      (i.Text.prototype.setStyle = function (t, e) {
        ...
        return (
          i.fontStyle && (s.fontStyle = i.fontStyle),
          i.fontVariant && (s.fontVariant = i.fontVariant),
          i.fontWeight && (s.fontWeight = i.fontWeight),
          i.fontSize &&
            ("number" == typeof i.fontSize && (i.fontSize = i.fontSize + "px"),
      ...
      (i.Text.prototype.updateText = function () {
        ...
        var t = this.text;
        this.characterLimitSize > -1 &&
          this.characterLimitSize < t.length &&
          (t =
        ...
        for (var a = 0; a < o; a++) {
          if (0 === i) {
            ...
            this.fontStyles.length > 0
              ? (u += this.measureLine(e[a]))
              : (u += this.context.measureText(e[a]).width),
            ...
            if (Array.isArray(i))
              for (var l = 0, c = 0; c < h.length; c++) {
                ...
                (d =
                  ...
                  this.fontWeights.length > 0 ||
                  this.fontStyles.length > 0
                    ? this.measureLine(h[c])
                    : Math.ceil(this.context.measureText(h[c]).width)),
                  c > 0 && (l += i[c - 1]),
                  (u = l + d);
              }
            else
              for (c = 0; c < h.length; c++)
                ...
                this.fontWeights.length > 0 ||
                this.fontStyles.length > 0
                  ? (u += this.measureLine(h[c]))
                  : (u += Math.ceil(this.context.measureText(h[c]).width)),
        ...
        var m, y;
        for (this._charCount = 0, a = 0; a < o; a++)
          (m = this.style.strokeThickness / 2),
            (y = this.style.strokeThickness / 2 + a * p + r.ascent),
            a > 0 && (y += g * a),
            "right" === this.style.align
              ? (m += n - s[a])
              : "center" === this.style.align && (m += (n - s[a]) / 2),
            this.autoRound && ((m = Math.round(m)), (y = Math.round(y))),
            this.colors.length > 0 ||
            this.strokeColors.length > 0 ||
            this.fontWeights.length > 0 ||
            this.fontStyles.length > 0
              ? this.updateLine(e[a], m, y)
              : (this.style.stroke &&
                  this.style.strokeThickness &&
                  (this.updateShadow(this.style.shadowStroke),
                  0 === i
                    ? this.context.strokeText(e[a], m, y)
                    : this.renderTabLine(e[a], m, y, !1)),
                this.style.fill &&
                  (this.updateShadow(this.style.shadowFill),
                  0 === i
                    ? this.context.fillText(e[a], m, y)
                    : this.renderTabLine(e[a], m, y, !0)));
      ...
      (i.Text.prototype.clearColors = function () {
        return (
          (this.colors = []), (this.strokeColors = []), (this.dirty = !0), this
        );
      }),
      ...
      (i.Text.prototype.advancedWordWrap = function (t) {
        for (
          ...
          var a = n[o],
            h = "";
          if (((a = a.replace(/^ *|\s*$/gi, "")), e.measureText(a).width < i))
            s += a + "\n";
          else {
      ...
      (i.Text.prototype.basicWordWrap = function (t) {
        for (var e = "", i = t.split("\n"), s = 0; s < i.length; s++) {
          for (
            var n = this.style.wordWrapWidth, r = i[s].split(" "), o = 0;
            o < r.length;
            o++
          ) {
      ...
      (i.Text.prototype.fontToComponents = function (t) {
        ...
        if (e) {
          var i = e[5].trim();
          return (
            /^(?:inherit|serif|sans-serif|cursive|fantasy|monospace)$/.exec(
              i
            ) ||
              /['",]/.exec(i) ||
              (i = "'" + i + "'"),
        ...
        return (
          console.warn("Phaser.Text - unparsable CSS font: " + t), { font: t }
        );
      }),
      (i.Text.prototype.componentsToFont = function (t) {
        var e,
          i = [];
        return (
          (e = t.fontStyle) && "normal" !== e && i.push(e),
      ...
      (i.Text.prototype.setTextBounds = function (t, e, s, n) {
        return (
          void 0 === t
            ? (this.textBounds = null)
            : (this.textBounds
                ? this.textBounds.setTo(t, e, s, n)
                : (this.textBounds = new i.Rectangle(t, e, s, n)),
      ...
      (i.Text.prototype.updateTexture = function () {
        ...
        if (
          ...
          "right" === this.style.boundsAlignH
            ? (r += this.textBounds.width - this.canvas.width / this.resolution)
            : "center" === this.style.boundsAlignH &&
              (r +=
                this.textBounds.halfWidth -
                this.canvas.width / this.resolution / 2),
            "bottom" === this.style.boundsAlignV
              ? (o +=
                  this.textBounds.height - this.canvas.height / this.resolution)
              : "middle" === this.style.boundsAlignV &&
                (o +=
                  this.textBounds.halfHeight -
      ...
      Object.defineProperty(i.Text.prototype, "align", {
        ...
        set: function (t) {
          (t = t.toLowerCase()) !== this.style.align &&
      ...
      Object.defineProperty(i.Text.prototype, "boundsAlignH", {
        ...
        set: function (t) {
          (t = t.toLowerCase()) !== this.style.boundsAlignH &&
      ...
      Object.defineProperty(i.Text.prototype, "boundsAlignV", {
        ...
        set: function (t) {
          (t = t.toLowerCase()) !== this.style.boundsAlignV &&
      ...
      Object.defineProperty(i.Text.prototype, "strokeThickness", {
        ...
        set: function (t) {
          t !== this.style.strokeThickness &&
            ((this.style.strokeThickness = Number(t)), (this.dirty = !0));
        },
      }),
      ...
      (i.Text.fontPropertiesContext =
        i.Text.fontPropertiesCanvas.getContext("2d")),
      ...
      (i.BitmapText.prototype = Object.create(
        PIXI.DisplayObjectContainer.prototype
      )),
      (i.BitmapText.prototype.constructor = i.BitmapText),
      i.Component.Core.install.call(i.BitmapText.prototype, [
        "Angle",
        "AutoCull",
        "Bounds",
        "Destroy",
      ...
      (i.BitmapText.prototype.preUpdatePhysics =
        i.Component.PhysicsBody.preUpdate),
      (i.BitmapText.prototype.preUpdateLifeSpan =
      ...
      (i.BitmapText.prototype.postUpdate = function () {
        i.Component.PhysicsBody.postUpdate.call(this),
          i.Component.FixedToCamera.postUpdate.call(this),
          this.body &&
            this.body.type === i.Physics.ARCADE &&
      ...
      (i.BitmapText.prototype.scanLine = function (t, e, i) {
        for (
          var s = 0,
            ...
            o = 0,
            a = null,
            h = this._maxWidth > 0 ? this._maxWidth : null,
            u = [],
            l = 0;
          l < i.length;
          l++
          ...
          var c = l === i.length - 1;
          if (/(?:\r\n|\r|\n)/.test(i.charAt(l)))
            return { width: n, text: i.substr(0, l), end: c, chars: u };
        ...
        return { width: n, text: i, end: c, chars: u };
      }),
      ...
      (i.BitmapText.prototype.updateText = function () {
        ...
        if (t) {
          ...
          for (
            ...
            var l = s[u];
            "right" === this._align
              ? (o = this.textWidth - l.width)
              : "center" === this._align &&
                (o = (this.textWidth - l.width) / 2);
            for (var c = 0; c < l.text.length; c++) {
              ...
              f
                ? (f.texture = p.texture)
                : (((f = new PIXI.Sprite(p.texture)).name = l.text[c]),
                  this._glyphs.push(f)),
      ...
      (i.TileSprite = function (t, e, s, n, r, o, a) {
        (e = e || 0),
          ...
          PIXI.Sprite.call(
            this,
            new PIXI.Texture(i.Cache.DEFAULT.baseTexture),
            n,
            r
          ),
      ...
      i.Component.Core.install.call(i.TileSprite.prototype, [
        "Angle",
        "Animation",
        "AutoCull",
        "Bounds",
      ...
      (i.TileSprite.prototype.preUpdatePhysics =
        i.Component.PhysicsBody.preUpdate),
      (i.TileSprite.prototype.preUpdateLifeSpan =
        i.Component.LifeSpan.preUpdate),
      ...
      (i.TileSprite.prototype.reset = function (t, e) {
        return (
          i.Component.Reset.prototype.reset.call(this, t, e),
      ...
      (i.TileSprite.prototype._renderWebGL = function (t) {
        if (this.visible && this.renderable && 0 !== this.alpha) {
          if (
            ...
            if ((this.generateTilingTexture(!0, t), !this.tilingTexture))
              return;
          ...
          var i = !1;
          this._filters &&
            ((i = !0), t.spriteBatch.stop(), t.filterManager.popFilter()),
            this._mask &&
              (i || t.spriteBatch.stop(), t.maskManager.popMask(this._mask, t)),
      ...
      (i.TileSprite.prototype._renderCanvas = function (t) {
        if (this.visible && this.renderable && 0 !== this.alpha) {
          ...
          if (
            ...
            16777215 === this.tint ||
              (!this.texture.requiresReTint && this.cachedTint === this.tint) ||
              ((this.tintedTexture = PIXI.CanvasTinter.getTintedTexture(
                this,
                this.tint
              )),
              (this.cachedTint = this.tint),
            ...
            if ((this.generateTilingTexture(!1, t), !this.tilingTexture))
              return;
          ...
          (a.x %= this.tilingTexture.baseTexture.width),
            ...
            e.scale(h.x, h.y),
            e.translate(
              a.x + this.anchor.x * -this._width,
              a.y + this.anchor.y * -this._height
            ),
      ...
      (i.TileSprite.prototype.generateTilingTexture = function (t) {
        if (this.texture.baseTexture.hasLoaded) {
          var e = this.texture,
            ...
            a = 0;
          this._frame.trimmed &&
            ((o = this._frame.spriteSourceSizeX),
            (a = this._frame.spriteSourceSizeY)),
            t &&
              ((n = i.Math.getNextPowerOfTwo(n)),
              (r = i.Math.getNextPowerOfTwo(r))),
            this.canvasBuffer
              ? (this.canvasBuffer.resize(n, r),
                (this.tilingTexture.baseTexture.width = n),
                (this.tilingTexture.baseTexture.height = r),
                (this.tilingTexture.needsUpdate = !0))
              : ((this.canvasBuffer = new PIXI.CanvasBuffer(n, r)),
                (this.tilingTexture = PIXI.Texture.fromCanvas(
      ...
      (i.TileSprite.prototype.getBounds = function () {
        var t = this._width,
          ...
          C = 1 / 0;
        (w =
          x < (w = y < (w = g < (w = p < w ? p : w) ? g : w) ? y : w) ? x : w),
          (C =
            _ < (C = v < (C = m < (C = f < C ? f : C) ? m : C) ? v : C)
              ? _
              : C),
          (b =
            x > (b = y > (b = g > (b = p > b ? p : b) ? g : b) ? y : b)
              ? x
              : b),
          (T =
            _ > (T = v > (T = m > (T = f > T ? f : T) ? m : T) ? v : T)
              ? _
              : T);
        var S = this._bounds;
        return (
      ...
      (i.Device.whenReady = function (t, e, i) {
        ...
        if (this.deviceReadyAt || !s) t.call(e, this);
          ...
          (s._queue = s._queue || []), s._queue.push([t, e]);
        else {
          ...
          "interactive" === document.readyState
            ...
            : n && !r
            ? document.addEventListener("deviceready", s._monitor, !1)
            : (document.addEventListener("DOMContentLoaded", s._monitor, !1),
        ...
        !(function () {
          ...
          /Playstation Vita/.test(t)
            ...
            ? ((s.iOS = !0),
              ...
              (s.iOSVersion = parseInt(RegExp.$1, 10)))
            : /Linux/.test(t)
            ? (s.linux = !0)
            : /Mac OS/.test(t)
            ? (s.macOS = !0)
            : /Windows/.test(t) && (s.windows = !0),
            (/Windows Phone/i.test(t) || /IEMobile/i.test(t)) &&
              ...
              (s.windowsPhone = !0));
          var e = /Silk/.test(t);
          (s.windows || s.macOS || (s.linux && !e) || s.chromeOS) &&
            (s.desktop = !0),
            (s.windowsPhone || (/Windows NT/i.test(t) && /Touch/i.test(t))) &&
              (s.desktop = !1);
        })(),
          (function () {
            var t = navigator.userAgent;
            if (
              (/Arora/.test(t)
                ...
                : /Edge\/\d+/.test(t)
                ? (s.edge = !0)
                : /Chrome\/(\d+)/.test(t) && !s.windowsPhone
                ? ((s.chrome = !0), (s.chromeVersion = parseInt(RegExp.$1, 10)))
                : /Epiphany/.test(t)
                ? (s.epiphany = !0)
                : /Firefox\D+(\d+)/.test(t)
                ? ((s.firefox = !0),
                  (s.firefoxVersion = parseInt(RegExp.$1, 10)))
                : /AppleWebKit/.test(t) && s.iOS
                ? (s.mobileSafari = !0)
                : /MSIE (\d+\.\d+);/.test(t)
                ...
                : /Opera/.test(t)
                ? (s.opera = !0)
                : /Safari\/(\d+)/.test(t) && !s.windowsPhone
                ? ((s.safari = !0),
                  /Version\/(\d+)\./.test(t) &&
              ...
              s.node &&
                ...
                ((s.nodeWebkit = !!process.versions["node-webkit"]),
            ...
            try {
              !!t.canPlayType &&
                (t
                  ...
                  .replace(/^no$/, "") && (s.oggVideo = !0),
                t
                  .canPlayType('video/mp4; codecs="avc1.42E01E"')
                  .replace(/^no$/, "") &&
                  ((s.h264Video = !0), (s.mp4Video = !0)),
                t
                  .canPlayType('video/webm; codecs="vp8, vorbis"')
                  .replace(/^no$/, "") && (s.webmVideo = !0),
                t.canPlayType('video/webm; codecs="vp9"').replace(/^no$/, "") &&
                  (s.vp9Video = !0),
                t
                  .canPlayType('application/x-mpegURL; codecs="avc1.42E01E"')
                  .replace(/^no$/, "") && (s.hlsVideo = !0));
            } catch (t) {}
          })(),
          (function () {
            var t,
          ...
          "undefined" != typeof ArrayBuffer &&
            ...
            ((s.littleEndian = t()), (s.LITTLE_ENDIAN = s.littleEndian)),
          (s.support32bit =
            "undefined" != typeof ArrayBuffer &&
          ...
          (function () {
            ...
            (s.file = !!(
              ...
              (window.URL =
                ...
                window.msURL),
              (s.getUserMedia =
                s.getUserMedia && !!navigator.getUserMedia && !!window.URL),
              s.firefox && s.firefoxVersion < 21 && (s.getUserMedia = !1),
              !s.iOS &&
                (s.ie || s.firefox || s.chrome) &&
                (s.canvasBitBltShift = !0),
          ...
          (function () {
            ...
            (e.globalCompositeOperation = "multiply"),
              ...
              (PIXI.CanvasTinter.tintMethod = s.canUseMultiply
                ? PIXI.CanvasTinter.tintWithMultiply
                : PIXI.CanvasTinter.tintWithPerPixel);
          })(),
          (function () {
            for (
              var t = [
      ...
      (i.Device.canPlayVideo = function (t) {
        return (
          !("webm" !== t || (!this.webmVideo && !this.vp9Video)) ||
          !("mp4" !== t || (!this.mp4Video && !this.h264Video)) ||
          !(("ogg" !== t && "ogv" !== t) || !this.oggVideo) ||
          !("mpeg" !== t || !this.hlsVideo)
        );
      }),
      (i.Device.needsTouchUnlock = function () {
        return !!(
          (!this.cocoonJS && (this.iOS || this.android)) ||
          ...
          return (
            ...
            e &&
              ("string" == typeof e
                ...
                : "object" == typeof e && 1 === e.nodeType && (s = e)),
            s || (s = document.body),
      ...
      (i.RequestAnimationFrame = function (t, e) {
        ...
        for (
          var i = ["ms", "moz", "webkit", "o"], s = 0;
          s < i.length && !window.requestAnimationFrame;
          s++
        )
          (window.requestAnimationFrame =
            window[i[s] + "RequestAnimationFrame"]),
      ...
      (i.Math = {
        ...
        snapTo: function (t, e, i) {
          return (
            void 0 === i && (i = 0),
            0 === e ? t : ((t -= i), (t = e * Math.round(t / e)), i + t)
          );
        },
        snapToFloor: function (t, e, i) {
          return (
            void 0 === i && (i = 0),
            0 === e ? t : ((t -= i), (t = e * Math.floor(t / e)), i + t)
          );
        },
        snapToCeil: function (t, e, i) {
          return (
            void 0 === i && (i = 0),
            0 === e ? t : ((t -= i), (t = e * Math.ceil(t / e)), i + t)
          );
        },
        ...
        rotateToAngle: function (t, e, s) {
          return (
            ...
            t === e
              ? t
              : (Math.abs(e - t) <= s || Math.abs(e - t) >= i.Math.PI2 - s
                  ? (t = e)
                  : (Math.abs(e - t) > Math.PI &&
                      (e < t ? (e += i.Math.PI2) : (e -= i.Math.PI2)),
                    e > t ? (t += s) : e < t && (t -= s)),
                t)
          );
        },
        ...
        wrapValue: function (t, e, i) {
          return (
            (t = Math.abs(t)), (e = Math.abs(e)), (i = Math.abs(i)), (t + e) % i
          );
        },
        isOdd: function (t) {
          return !!(1 & t);
        ...
        linearInterpolation: function (t, e) {
          var i = t.length - 1,
            ...
            n = Math.floor(s);
          return e < 0
            ? this.linear(t[0], t[1], s)
            : e > 1
            ? this.linear(t[i], t[i - 1], i - s)
            : this.linear(t[n], t[n + 1 > i ? i : n + 1], s - n);
        },
        ...
        catmullRomInterpolation: function (t, e) {
          ...
          return t[0] === t[i]
            ...
            : e > 1
            ? t[i] -
              (this.catmullRom(t[i], t[i], t[i - 1], t[i - 1], s - i) - t[i])
            : this.catmullRom(
                t[n ? n - 1 : 0],
                t[n],
                t[i < n + 1 ? i : n + 1],
        ...
        sinCosGenerator: function (t, e, i, s) {
          void 0 === e && (e = 1),
            ...
            void 0 === s && (s = 1);
          for (
            var n = e, r = i, o = (s * Math.PI) / t, a = [], h = [], u = 0;
            u < t;
            u++
          )
            (n += (r -= n * o) * o), (a[u] = r), (h[u] = n);
        ...
        smoothstep: function (t, e, i) {
          return (
            (t = Math.max(0, Math.min(1, (t - e) / (i - e)))) * t * (3 - 2 * t)
          );
        },
      ...
      (i.RandomDataGenerator.prototype = {
        ...
        hash: function (t) {
          ...
          for (s = 4022871197, t = t.toString(), i = 0; i < t.length; i++)
            (e = 0.02519603282416938 * (s += t.charCodeAt(i))),
              (e -= s = e >>> 0),
              (s = (e *= s) >>> 0),
              (s += 4294967296 * (e -= s));
      ...
      (i.QuadTree.prototype = {
        ...
        retrieve: function (t) {
          ...
          return (
            this.nodes[0] &&
              (e =
                -1 !== s
                  ? e.concat(this.nodes[s].retrieve(t))
                  : (e = (e = (e = e.concat(this.nodes[0].retrieve(t))).concat(
                      this.nodes[1].retrieve(t)
                    )).concat(this.nodes[2].retrieve(t))).concat(
                      this.nodes[3].retrieve(t)
                    )),
            e
          );
        },
        clear: function () {
          ...
          for (var t = this.nodes.length; t--; )
            this.nodes[t].clear(), this.nodes.splice(t, 1);
          this.nodes.length = 0;
        },
      }),
      ...
      (i.Net.prototype = {
        ...
        updateQueryString: function (t, e, i, s) {
          ...
          if (r.test(s))
            n =
              void 0 !== e && null !== e
                ? s.replace(r, "$1" + t + "=" + e + "$2$3")
                : s.replace(r, "$1$3").replace(/(&|\?)$/, "");
      ...
      (i.TweenManager.prototype = {
        ...
        removeFrom: function (t, e) {
          ...
          if (Array.isArray(t))
            ...
            for (s = 0, n = this._tweens.length; s < n; s++)
              t === this._tweens[s].target && this.remove(this._tweens[s]);
            for (s = 0, n = this._add.length; s < n; s++)
        ...
        isTweening: function (t, e) {
          return (
            ...
            this._tweens.some(function (i) {
              return (
                i.target === t && (!e || (i.isRunning && !i.pendingDelete))
              );
            })
          );
        },
      ...
      (i.Tween.prototype = {
        to: function (t, e, s, n, r, o, a) {
          return (
            ...
            void 0 === a && (a = !1),
            "string" == typeof s &&
              this.manager.easeMap[s] &&
              (s = this.manager.easeMap[s]),
            this.isRunning
              ? (console.warn(
                  "Phaser.Tween.to cannot be called after Tween.start"
                ),
                this)
              : (this.timeline.push(new i.TweenData(this).to(t, e, s, r, o, a)),
                n && this.start(),
                this)
          );
        },
        from: function (t, e, s, n, r, o, a) {
          return (
            ...
            this.isRunning
              ? (console.warn(
                  "Phaser.Tween.from cannot be called after Tween.start"
                ),
                this)
              : (this.timeline.push(
                  new i.TweenData(this).from(t, e, s, r, o, a)
                ),
                n && this.start(),
                this)
          );
        ...
        start: function (t) {
          if ((void 0 === t && (t = 0), this.pendingDelete))
            return (
              console.warn(
                "Phaser.Tween.start cannot be called after Tween.stop"
              ),
              this
            );
          if (
        ...
        loop: function (t) {
          return (
            void 0 === t && (t = !0), (this.repeatCounter = t ? -1 : 0), this
          );
        },
        ...
        _pause: function () {
          this._codePaused ||
            ((this.isPaused = !0), (this._pausedTime = this.game.time.time));
        },
        resume: function () {
          if (this.isPaused) {
        ...
        update: function (t) {
          ...
          if (e === i.TweenData.LOOPED)
            return (
              -1 === this.timeline[this.current].repeatCounter
          ...
          if (e === i.TweenData.COMPLETE) {
            ...
            return (
              this.reverse
                ? --this.current < 0 &&
                  ((this.current = this.timeline.length - 1), (s = !0))
      ...
      (i.TweenData.prototype = {
        ...
        start: function () {
          ...
          return (
            (this.value = 0), (this.repeatCounter = this.repeatTotal), this
          );
        },
        loadValues: function () {
        ...
        update: function (t) {
          ...
          for (var s in this.vEnd) {
            var n = this.vStart[s],
              r = this.vEnd[s];
            Array.isArray(r)
              ? (this.parent.target[s] = this.interpolationFunction.call(
                  this.interpolationContext,
                  r,
                  this.value
                ))
              : (this.parent.target[s] = n + (r - n) * this.value);
          }
          return (!this.parent.reverse && 1 === this.percent) ||
            (this.parent.reverse && 0 === this.percent)
            ? this.repeat()
            : i.TweenData.RUNNING;
        },
        generateData: function (t) {
          ...
          do {
            this.parent.reverse
              ? ((this.dt -= s), (this.dt = Math.max(this.dt, 0)))
              : ((this.dt += s), (this.dt = Math.min(this.dt, this.duration))),
              (this.percent = this.dt / this.duration),
              (this.value = this.easingFunction(this.percent));
            var n = {};
            for (var r in this.vEnd) {
              var o = this.vStart[r],
                a = this.vEnd[r];
              Array.isArray(a)
                ? (n[r] = this.interpolationFunction.call(
                    this.interpolationContext,
                    a,
                    this.value
                  ))
                : (n[r] = o + (a - o) * this.value);
            }
            e.push(n),
        ...
        update: function (t) {
          ...
          (this.time = Date.now()),
            ...
            this.game.raf._isSetTimeOut &&
              ((this.timeToCall = Math.floor(
                Math.max(0, 1e3 / this._desiredFps - (this.timeExpected - t))
              )),
          ...
          if (
            ...
            this._frameCount >= 2 * this._desiredFps &&
              ((this.suggestedFps =
                5 *
                Math.floor(
                  200 / (this._elapsedAccumulator / this._frameCount)
                )),
              (this._frameCount = 0),
              (this._elapsedAccumulator = 0)),
      ...
      (i.Timer.prototype = {
        ...
        remove: function (t) {
          for (var e = 0; e < this.events.length; e++)
            if (this.events[e] === t)
              return (this.events[e].pendingDelete = !0), !0;
          return !1;
        },
        order: function () {
        ...
        pause: function () {
          this.running &&
            ((this._codePaused = !0),
            this.paused ||
              ((this._pauseStarted = this.game.time.time), (this.paused = !0)));
        },
        _pause: function () {
          !this.paused &&
            this.running &&
      ...
      (i.AnimationManager.prototype = {
        ...
        stop: function (t, e) {
          void 0 === e && (e = !1),
            !this.currentAnim ||
              ("string" == typeof t && t !== this.currentAnim.name) ||
      ...
      Object.defineProperty(i.AnimationManager.prototype, "frame", {
        ...
        set: function (t) {
          ...
          "number" == typeof t &&
            this._frameData &&
            (e = this._frameData.getFrame(t)) &&
            ((this.currentFrame = e), this.sprite.setFrame(this.currentFrame));
        },
      }),
      Object.defineProperty(i.AnimationManager.prototype, "frameName", {
        ...
        set: function (t) {
          ...
          "string" == typeof t &&
          this._frameData &&
          (e = this._frameData.getFrameByName(t))
            ? ((this.currentFrame = e),
          ...
          (this._frameData = t),
            (this.currentFrame = this._frameData
              ? this._frameData.getFrame(
                  this._frames[this._frameIndex % this._frames.length]
                )
              : null);
        },
        destroy: function () {
      ...
      Object.defineProperty(i.Animation.prototype, "enableUpdate", {
        ...
        set: function (t) {
          t && null === this.onUpdate
            ? (this.onUpdate = new i.Signal())
            : t ||
              null === this.onUpdate ||
      ...
      (i.Frame.prototype = {
        ...
        getRect: function (t) {
          return (
            void 0 === t
              ? (t = new i.Rectangle(this.x, this.y, this.width, this.height))
              : t.setTo(this.x, this.y, this.width, this.height),
            t
          );
        },
      ...
      (i.FrameData.prototype = {
        ...
        clone: function () {
          ...
          for (var s in this._frameNames)
            this._frameNames.hasOwnProperty(s) &&
              t._frameNames.push(this._frameNames[s]);
          return t;
        },
      ...
      (i.AnimationParser = {
        spriteSheet: function (t, e, s, n, r, o, a, h) {
          void 0 === r && (r = -1),
            ...
            void 0 === h && (h = 0);
          var u = e;
          if (("string" == typeof e && (u = t.cache.getImage(e)), null === u))
            return null;
          var l = u.width,
            c = u.height;
            ...
            return (
              console.warn(
                "Phaser.AnimationParser.spriteSheet: skipFrames = " +
                  h.toString() +
                  " is larger than total sprite number " +
                  d.toString()
              ),
              null
            );
          ...
          if (
            ([
              ...
              if (!e[t])
                return (
                  console.warn(
                    'Phaser.AnimationParser.JSONDataPyxel: Invalid Pyxel Tilemap JSON given, missing "' +
                      t +
                      '" key.'
                  ),
                  void console.log(e)
            ...
            return (
              console.warn(
                "Phaser.AnimationParser.JSONDataPyxel: Too many layers, this parser only supports flat Tilemaps."
              ),
              void console.log(e)
            );
          for (
            var s = new i.FrameData(),
              n = e.tileheight,
              r = e.tilewidth,
              o = e.layers[0].tiles,
              a = 0;
            ...
            s.addFrame(
              new i.Frame(a, o[a].x, o[a].y, r, n, "frame_" + a)
            ).setTrim(!1);
          return s;
        },
            ...
            (s = n.addFrame(
              ...
              r[a].trimmed &&
                s.setTrim(
                  ...
                  r[a].sourceSize.w,
                  r[a].sourceSize.h,
                  r[a].spriteSourceSize.x,
                  r[a].spriteSourceSize.y,
                  r[a].spriteSourceSize.w,
                  r[a].spriteSourceSize.h
                ),
          ...
          if (e.getElementsByTagName("TextureAtlas")) {
            for (
              ...
              (n = (r = g[m].attributes).name.value),
                ...
                (c = null),
                r.frameX &&
                  ((l = Math.abs(parseInt(r.frameX.value, 10))),
      ...
      (i.Cache.prototype = {
        addCompressedTextureMetaData: function (t, e, s, n) {
          ...
          return (
            o.frameData.addFrame(new i.Frame(0, 0, 0, r.width, r.height, e)),
        ...
        addImage: function (t, e, s) {
          ...
          return (
            n.frameData.addFrame(new i.Frame(0, 0, 0, s.width, s.height, e)),
            (this._cache.image[t] = n),
            this._resolveURL(e, n),
            "__default" === t
              ? (i.Cache.DEFAULT = new PIXI.Texture(n.base))
              : "__missing" === t &&
                (i.Cache.MISSING = new PIXI.Texture(n.base)),
            n
          );
        },
        ...
        addPhysicsData: function (t, e, i, s) {
          (this._cache.physics[t] = { url: e, data: i, format: s }),
            this._resolveURL(e, this._cache.physics[t]);
        },
        addTilemap: function (t, e, i, s) {
          (this._cache.tilemap[t] = { url: e, data: i, format: s }),
        ...
        addBitmapData: function (t, e, s) {
          return (
            ...
            (this._cache.bitmapData[t] = { data: e, frameData: s }),
            e
          );
        },
        ...
        addBitmapFontFromAtlas: function (t, e, s, n, r, o, a) {
          ...
          if (h) {
            var u = { font: null, base: this.getBaseTexture(e), frame: h };
            void 0 === o && (o = 0), void 0 === a && (a = 0);
            var l;
            "json" === r
              ? ((l = this.getJSON(n)),
                (u.font = i.LoaderParser.jsonBitmapFont(
                  l,
                  u.base,
                  o,
                  a,
              ...
              : ((l = this.getXML(n)),
                (u.font = i.LoaderParser.xmlBitmapFont(
                  l,
                  u.base,
                  o,
                  a,
        ...
        addVideo: function (t, e, i, s) {
          (this._cache.video[t] = { url: e, data: i, isBlob: s, locked: !0 }),
        ...
        addSpriteSheet: function (t, e, s, n, r, o, a, h, u) {
          ...
          var l = {
            ...
            spacing: h,
            base: new PIXI.BaseTexture(s, null, this.game.resolution),
            frameData: i.AnimationParser.spriteSheet(
              this.game,
              s,
              n,
              r,
        ...
        addTextureAtlas: function (t, e, s, n, r) {
          ...
          r === i.Loader.TEXTURE_ATLAS_XML_STARLING
            ? (o.frameData = i.AnimationParser.XMLData(this.game, n, t))
            : r === i.Loader.TEXTURE_ATLAS_JSON_PYXEL
            ? (o.frameData = i.AnimationParser.JSONDataPyxel(this.game, n, t))
            : Array.isArray(n.frames)
            ? (o.frameData = i.AnimationParser.JSONData(this.game, n, t))
        ...
        getItem: function (t, e, i, s) {
          return this.checkKey(e, t)
            ? void 0 === s
              ? this._cacheMap[e][t]
              : this._cacheMap[e][t][s]
            : (i &&
                console.warn(
                  "Phaser.Cache." + i + ': Key "' + t + '" not found in Cache.'
                ),
              null);
        },
        ...
        getImage: function (t, e) {
          ...
          return (
            null === s &&
              (s = this.getItem("__missing", i.Cache.IMAGE, "getImage")),
            e ? s : s.data
          );
        },
        ...
        getPhysicsData: function (t, e, s) {
          ...
          if (n[e]) {
            ...
            console.warn(
              'Phaser.Cache.getPhysicsData: Could not find given fixtureKey: "' +
                s +
                " in " +
                t +
                '"'
        ...
        getJSON: function (t, e) {
          ...
          return s
            ? e
              ? i.Utils.extend(!0, Array.isArray(s) ? [] : {}, s)
              : s
            : null;
        },
        getXML: function (t) {
        ...
        getURL: function (t) {
          return (t = this._resolveURL(t))
            ? this._urlMap[t]
            : (console.warn(
                'Phaser.Cache.getUrl: Invalid url: "' +
                  t +
        ...
        destroy: function () {
          for (var t = 0; t < this._cacheMap.length; t++) {
            ...
            for (var i in e)
              "__default" !== i &&
                "__missing" !== i &&
                (this.destroyItem(e[i]), delete e[i]);
          }
          (this._urlMap = null),
        ...
        destroyItem: function (t) {
          t.destroy
            ? t.destroy()
            : (t.base && t.base.destroy && t.base.destroy(),
        ...
        _addImages: function () {
          ...
          i.Cache.READY_TIMEOUT > 0
            ? setTimeout(function () {
                t.isReady ||
                  (console.warn(
                    "Phaser.Cache: Still waiting for images after %s ms.",
                    e
                  ),
                  t._ready());
              }, i.Cache.READY_TIMEOUT)
            : this._ready();
        },
      ...
      (i.Loader.prototype = {
        setPreloadSprite: function (t, e) {
          (e = e || 0),
            ...
            (this.preloadSprite.rect =
              0 === e
                ? new i.Rectangle(0, 0, 1, t.height)
                : new i.Rectangle(0, 0, t.width, 1)),
            t.crop(this.preloadSprite.rect),
            (t.visible = !0);
        },
        resize: function () {
          this.preloadSprite &&
            this.preloadSprite.height !== this.preloadSprite.sprite.height &&
        ...
        addToFileList: function (t, e, i, s, n, r) {
          if ((void 0 === n && (n = !1), void 0 === e || "" === e))
            return (
              console.warn(
                "Phaser.Loader: Invalid or no key given of type " + t
              ),
              this
            );
          if (void 0 === i || null === i) {
            if (!r)
              return (
                console.warn(
                  "Phaser.Loader: No URL given for file type: " +
                    t +
                    " key: " +
                    e
                ),
        ...
        pack: function (t, e, i, s) {
          if (
            ...
            return (
              console.warn(
                "Phaser.Loader.pack - Both url and data are null. One must be set."
              ),
              this
            );
          var n = {
        ...
        imageFromGrid: function (t, e, i, s, n, r) {
          return this.imageFromBitmapData(
            t,
            this.game.create.grid(t, e, i, s, n, r, !1)
          );
        },
        imageFromTexture: function (t, e, i, s, n) {
          return this.imageFromBitmapData(
            t,
            this.game.create.texture(t, e, i, s, n, !1)
          );
        },
        texture: function (t, e, s) {
          if (this.game.renderType === i.WEBGL) {
            var n,
              r = this.game.renderer.extensions.compression;
            for (n in e)
          ...
          return (
            e.truecolor &&
              this.addToFileList("image", t, e.truecolor, void 0, s, ".png"),
            this
          );
        },
        images: function (t, e) {
        ...
        script: function (t, e, i, s) {
          return (
            ...
            this.addToFileList(
              ...
              t,
              e,
              { syncPoint: !0, callback: i, callbackContext: s },
              !1,
              ".js"
            )
          );
          ...
          return this.game.sound.noAudio
            ...
            : (void 0 === i && (i = null),
              ...
              i
                ...
                : console.warn(
                    "Phaser.Loader.audiosprite - You must specify either a jsonURL or provide a jsonData object"
                  ),
              this);
        },
        audiosprite: function (t, e, i, s, n) {
        ...
        video: function (t, e, i, s) {
          return (
            void 0 === i &&
              (i = this.game.device.firefox ? "loadeddata" : "canplaythrough"),
            void 0 === s && (s = !1),
            "string" == typeof e && (e = [e]),
        ...
        physics: function (t, e, s, n) {
          return (
            ...
            s
              ? ("string" == typeof s && (s = JSON.parse(s)),
                this.cache.addPhysicsData(t, null, s, n))
        ...
        processLoadQueue: function () {
          ...
          for (i = 0; i < this._flightQueue.length; i++)
            ((s = this._flightQueue[i]).loaded || s.error) &&
          ...
          for (
            var t = !1,
              e = this.enableParallel
                ? Math.max(1, this.maxParallelDownloads)
                : 1,
              i = this._processingHead;
            i < this._fileList.length;
            i++
          ) {
            ...
            if (
              ...
              s.loaded || s.error
                ? i === this._processingHead && (this._processingHead = i + 1)
                : !s.loading &&
                  this._flightQueue.length < e &&
                  ("packfile" !== s.type || s.data
                    ? t ||
              ...
              this._flightQueue.length >= e ||
                (t && this._loadedPackCount === this._totalPackCount))
            )
              break;
          }
          if (
            ...
            console.warn(
              "Phaser.Loader - aborting: processing queue empty, loading may have stalled"
            );
            var n = this;
            setTimeout(function () {
              n.finishedLoading(!0);
        ...
        xhrLoad: function (t, e, i, s, n) {
          ...
          r.open("GET", e, !0),
            (r.responseType = i),
            !1 !== this.headers.requestedWith &&
              r.setRequestHeader(
                "X-Requested-With",
                this.headers.requestedWith
              ),
            this.headers[t.type] &&
              r.setRequestHeader("Accept", this.headers[t.type]),
            (n = n || this.fileError);
          var o = this;
          (r.onload = function () {
            try {
              return 4 === r.readyState && r.status >= 400 && r.status <= 599
                ? n.call(o, t, r)
                : s.call(o, t, r);
            } catch (e) {
              o.hasLoaded
        ...
        getVideoURL: function (t) {
          for (var e = 0; e < t.length; e++) {
            var i,
              s = t[e];
            if (s.uri) {
              if (((i = s.type), (s = s.uri), this.game.device.canPlayVideo(i)))
                return s;
            } else {
              ...
              if (
                ...
                (i = s
                  .substr((Math.max(0, s.lastIndexOf(".")) || 1 / 0) + 1)
                  .toLowerCase()),
        ...
        getAudioURL: function (t) {
          ...
          for (var e = 0; e < t.length; e++) {
            var i,
              s = t[e];
            if (s.uri) {
              if (((i = s.type), (s = s.uri), this.game.device.canPlayAudio(i)))
                return s;
            } else {
              if (0 === s.indexOf("blob:") || 0 === s.indexOf("data:"))
                return s;
        ...
        fileError: function (t, e, i) {
          var s =
            "error loading asset from URL " +
            (t.requestUrl || this.transformUrl(t.url, t));
          !i && e && (i = e.status),
            i && (s = s + " (" + i + ")"),
          ...
          switch (t.type) {
            ...
            case "textureatlas":
              if (null == t.atlasURL)
                ...
                ((s = !1),
                t.format === i.Loader.TEXTURE_ATLAS_JSON_ARRAY ||
                  t.format === i.Loader.TEXTURE_ATLAS_JSON_HASH ||
                  t.format === i.Loader.TEXTURE_ATLAS_JSON_PYXEL)
              )
                this.xhrLoad(
                  t,
                ...
                ? ((s = !1),
                  this.xhrLoad(
                    ...
                    function (t, e) {
                      ...
                      i
                        ? ((t.atlasType = "json"), this.jsonLoadComplete(t, e))
                        : ((t.atlasType = "xml"), this.xmlLoadComplete(t, e));
                    }
                  ))
            ...
            case "video":
              if (t.asBlob)
                try {
                  ...
                  throw new Error(
                    "Phaser.Loader. Unable to parse video file as Blob: " +
                      t.key
                  );
                }
        ...
        xmlLoadComplete: function (t, e) {
          ...
          if (!s) {
            ...
            return (
              console.warn(
                "Phaser.Loader - " + t.key + ": invalid XML (" + n + ")"
              ),
      ...
      (i.LoaderParser = {
        ...
        xmlBitmapFont: function (t, e, i, s, n, r) {
          ...
          (o.font = a.getAttribute("face")),
            ...
            (o.chars = {});
          for (
            var u = t.getElementsByTagName("char"),
              l = n ? n.x : 0,
              c = n ? n.y : 0,
              d = 0;
            d < u.length;
        ...
        jsonBitmapFont: function (t, e, i, s, n, r) {
          ...
          var o = {
            ...
            h = n ? n.y : 0;
          return (
            t.font.chars.char.forEach(function (t) {
            ...
            t.font.kernings &&
              ...
              t.font.kernings.kerning.forEach(function (t) {
                o.chars[t._second].kerning[t._first] =
                  parseInt(t._amount, 10) / r;
              }),
        ...
        finalizeBitmapFont: function (t, e) {
          return (
            Object.keys(e.chars).forEach(function (s) {
              var n = e.chars[s];
              n.texture = new PIXI.Texture(
                t,
                new i.Rectangle(n.x, n.y, n.width, n.height)
              );
            }),
            e
          );
        ...
        pvr: function (t) {
          var e,
            i = new Uint32Array(t.slice(0, 52)),
            s = new Uint8Array(t),
            n = null,
            r = (i[3] << 32) | i[2],
            o = 0;
            ...
            68 === e[0] &&
              ...
              "DX10" ===
                (s = {
                  ...
                  formatFlag: i[19],
                  formatFourCC: [
                    String.fromCharCode(e[84]),
                    String.fromCharCode(e[85]),
                    String.fromCharCode(e[86]),
                    String.fromCharCode(e[87]),
                  ].join(""),
                  formatBitCount: i[21],
                  formatRBitMask: i[22],
                  formatGBitMask: i[23],
        ...
        ktx: function (t) {
          ...
          if (
            ...
            10 === e[11] &&
            [
              36196, 35840, 35841, 35842, 35843, 33776, 33777, 33778, 33779,
            ].indexOf(o) >= 0
          ) {
            switch (o) {
              case 36196:
      ...
      (i.Sound.prototype = {
        ...
        onEndedHandler: function () {
          (this._sound.onended = null),
            ...
            this._markedToDelete &&
              (this.externalNode
                ? this._sound.disconnect(this.externalNode)
                : this.gainNode && this._sound.disconnect(this.gainNode),
              this._removeFromSoundManager
        ...
        play: function (t, e, i, s, n) {
          ...
          if ("" !== t) {
            if (!this.markers[t])
              return (
                console.warn(
                  "Phaser.Sound.play: audio marker " + t + " doesn't exist"
                ),
                this
              );
          ...
          return (
            ...
            this.playOnce &&
              (this.loop &&
                console.warn(
                  "Phaser.Sound.play: audio clip " +
                    this.name +
                    " cannot be deleted while looping."
                ),
              (this._markedToDelete = !0),
              (this._removeFromSoundManager = !0)),
            this
        ...
        resume: function () {
          if (this.paused && this._sound) {
            if (this.usingWebAudio) {
              ...
              (this._sound.currentTime = this._tempPause), this._sound.play();
            (this.isPlaying = !0),
              (this.paused = !1),
          ...
          if (this.isPlaying && this._sound)
            if (this.usingWebAudio) {
              ...
              this.usingAudioTag &&
                (this._sound.pause(), (this._sound.currentTime = 0));
          if (
            ((this.pendingPlayback = !1), (this.isPlaying = !1), !this.paused)
          ) {
          ...
          this.isPlaying &&
            ...
            void 0 !== e
              ? ((this.fadeTween = this.game.add
                  .tween(this)
                  .to({ volume: e }, t, i.Easing.Linear.None, !0)),
            ...
            this._muted
              ...
              : ((this._tempVolume = t),
                ...
                this.usingWebAudio
                  ...
                  : this.usingAudioTag &&
                    this._sound &&
                    (this._sound.volume = this._globalVolume * t));
        },
      }),
      ...
      (i.SoundManager.prototype = {
        boot: function () {
          ...
          this.noAudio || (t.needsTouchUnlock() && this.setTouchLock()),
            this.usingWebAudio &&
              ...
              t.chromeVersion <= 65 &&
              console.log(
                'A "GainNode.gain.value setter smoothing is deprecated" notice in Chrome is normal. <https://github.com/photonstorm/phaser-ce/issues/385>'
              );
        },
        ...
        setDecodedCallback: function (t, e, s) {
          ...
          0 === this._watchList.total
            ? ((this._watching = !1), e.call(s))
            : ((this._watching = !0),
        ...
        remove: function (t) {
          for (var e = this._sounds.length; e--; )
            if (this._sounds[e] === t)
              return this._sounds[e].destroy(!1), this._sounds.splice(e, 1), !0;
          return !1;
        },
        removeAll: function () {
          this.stopAll();
      ...
      Object.defineProperty(i.SoundManager.prototype, "volume", {
        ...
        set: function (t) {
          if ((t < 0 ? (t = 0) : t > 1 && (t = 1), this._volume !== t)) {
            if (((this._volume = t), this.usingWebAudio))
      ...
      (i.ScaleManager.prototype = {
        boot: function () {
          ...
          (t.supportsFullScreen =
            ...
            this.game.device.iPad ||
              ...
              (this.game.device.android && !this.game.device.chrome
                ? (t.scrollTo = new i.Point(0, 1))
                : (t.scrollTo = new i.Point(0, 0))),
            this.game.device.desktop
          ...
          (this._orientationChange = function (t) {
            ...
            (this.screenOrientation = this.dom.getScreenOrientation(
              this.compatibility.orientationFallback
            )),
            i.FlexGrid &&
              (this.grid = new i.FlexGrid(this, this.width, this.height)),
            (this._booted = !0),
            null !== this._pendingScaleMode &&
        ...
        parseConfig: function (t) {
          void 0 !== t.scaleMode &&
            ...
            t.scaleH &&
              t.scaleV &&
              this.setUserScale(t.scaleH, t.scaleV, t.trimH, t.trimV);
        },
        setupScale: function (t, e) {
          var s,
            n = new i.Rectangle();
          "" !== this.game.parent &&
            ("string" == typeof this.game.parent
              ? (s = document.getElementById(this.game.parent))
              : this.game.parent &&
                1 === this.game.parent.nodeType &&
                (s = this.game.parent)),
            s
              ? ((this.parentNode = s),
                (this.parentIsWindow = !1),
        ...
        setGameSize: function (t, e) {
          this._gameSize.setTo(0, 0, t, e),
            this.currentScaleMode !== i.ScaleManager.RESIZE &&
        ...
        signalSizeChange: function () {
          if (
            !i.Rectangle.sameDimensions(this, this._lastReportedCanvasSize) ||
            !i.Rectangle.sameDimensions(this.game, this._lastReportedGameSize)
          ) {
            var t = this.width,
              e = this.height;
        ...
        preUpdate: function () {
          if (
            ...
            this._updateThrottle < t &&
              (a = Math.min(t, this._updateThrottleReset)),
              (this._updateThrottle = i.Math.clamp(
                a,
                25,
          ...
          void 0 === e && (e = !1),
            !0 !== t || !0 !== e
              ? ((this.forceLandscape = t),
                ...
                this.queueUpdate(!0))
              : console.warn(
                  "Phaser.ScaleManager: forceLandscape and forcePortrait cannot both be true."
                );
        },
        ...
        updateLayout: function () {
          ...
          if (t !== i.ScaleManager.RESIZE) {
            if (
              ...
              this.incorrectOrientation
                ? this.setMaximum()
                : t === i.ScaleManager.EXACT_FIT
                ? this.setExactFit()
                : t === i.ScaleManager.SHOW_ALL
                ? !this.isFullScreen &&
                  this.boundingParent &&
                  this.compatibility.canExpandParent
                  ? (this.setShowAll(!0), this.resetCanvas(), this.setShowAll())
                  : this.setShowAll()
                : t === i.ScaleManager.NO_SCALE
                ? ((this.width = this.game.width),
                  (this.height = this.game.height))
                : t === i.ScaleManager.USER_SCALE &&
                  ((this.width =
        ...
        getParentBounds: function (t) {
          ...
          if (s) {
            var o = s.getBoundingClientRect(),
              a = s.offsetParent
                ? s.offsetParent.getBoundingClientRect()
        ...
        alignCanvas: function (t, e) {
          ...
          if (t) {
            ...
            (s.style.marginLeft = n.left + "px"),
              0 !== n.left &&
                ((n.right = -(i.width - h.width - n.left)),
          ...
          if (e) {
            ...
            (s.style.marginTop = n.top + "px"),
              0 !== n.top &&
                ((n.bottom = -(i.height - h.height - n.top)),
        ...
        reflowCanvas: function () {
          this.incorrectOrientation ||
            ((this.width = i.Math.clamp(
              this.width,
              this.minWidth || 0,
              this.maxWidth || this.width
            )),
            (this.height = i.Math.clamp(
              this.height,
              this.minHeight || 0,
        ...
        setShowAll: function (t) {
          var e,
            ...
            n = i.height;
          (e = t
            ? Math.max(n / this.game.height, s / this.game.width)
            : Math.min(n / this.game.height, s / this.game.width)),
          ...
          if (this.isFullScreen) return !1;
          {
            if (this.compatibility.supportsFullScreen) {
              if ("when-not-mouse" === this.compatibility.clickTrampoline) {
                ...
                if (
                  s.activePointer &&
                  s.activePointer !== s.mousePointer &&
                  (e || !1 !== e)
                )
                  return void s.activePointer.addClickTrampoline(
                    "startFullScreen",
        ...
        stopFullScreen: function () {
          return (
            !(!this.isFullScreen || !this.compatibility.supportsFullScreen) &&
            ((this.hasPhaserSetFullScreen = !1),
        ...
        prepScreenMode: function (t) {
          ...
          t
            ? (e || this.fullScreenScaleMode === i.ScaleManager.EXACT_FIT) &&
              s !== this.game.canvas &&
              ...
              (s.style.height = "100%"))
            : (this._fullScreenRestore &&
                ((s.style.width = this._fullScreenRestore.targetWidth),
        ...
        scaleSprite: function (t, e, i, s) {
          ...
          return (
            (h = h ? s : !s)
              ? ((t.width = Math.floor(n)), (t.height = Math.floor(r)))
              : ((t.width = Math.floor(o)), (t.height = Math.floor(a))),
            t
          );
        },
        destroy: function () {
      ...
      Object.defineProperty(i.ScaleManager.prototype, "isPortrait", {
        get: function () {
          return (
            "portrait" === this.classifyOrientation(this.screenOrientation)
          );
        },
      }),
      Object.defineProperty(i.ScaleManager.prototype, "isLandscape", {
        get: function () {
          return (
            "landscape" === this.classifyOrientation(this.screenOrientation)
          );
        },
      }),
      ...
      (i.Utils.Debug.prototype = {
        boot: function () {
          this.game.renderType === i.CANVAS
            ...
            : ((this.bmd = new i.BitmapData(
              ...
              (this.canvas = i.CanvasPool.create(
                this,
                this.game.width,
                this.game.height
              )),
        ...
        sound: function (t, e, i) {
          ...
          this.start(t, e, i),
            s.noAudio
              ...
              : (this.line(
                  "Volume: " + s.volume.toFixed(2) + (s.mute ? " (Mute)" : "")
                ),
                this.line("Mute on pause: " + s.muteOnPause),
                this.line(
                  "Using: " +
                    (s.usingWebAudio
                      ? "Web Audio - " + s.context.state
                      : "Audio Tag")
                ),
        ...
        soundInfo: function (t, e, i, s) {
          this.start(e, i, s),
            this.line(
              "Sound: " + t.key + " Touch locked: " + t.game.sound.touchLocked
            ),
            this.line(
              "Is Ready?: " +
            ...
            this.line(
              "Volume: " + t.volume.toFixed(2) + (t.mute ? " (Mute)" : "")
            ),
            this.line(
              "Using: " + (t.usingWebAudio ? "Web Audio" : "Audio Tag")
            ),
            "" !== t.currentMarker &&
              (this.line(
                "Marker: " +
        ...
        camera: function (t, e, i) {
          var s = t.deadzone,
            ...
            r = t.view;
          s &&
            (this._rect.setTo(r.x + s.x, r.y + s.y, s.width, s.height),
            this.rectangle(this._rect, e, i)),
            n &&
              (this._line.setTo(r.centerX, r.centerY, n.x, n.y),
        ...
        timer: function (t, e, i, s) {
          this.start(e, i, s),
            this.line(
              "Timer (running: " + t.running + " expired: " + t.expired + ")"
            ),
        ...
        body: function (t, e, s) {
          t.body &&
            (this.start(),
            t.body.type === i.Physics.ARCADE
              ? i.Physics.Arcade.Body.render(
                  this.context,
                  t.body,
                  e,
                  s,
              ...
              : t.body.type === i.Physics.NINJA
              ? i.Physics.Ninja.Body.render(this.context, t.body, e, s)
              : t.body.type === i.Physics.BOX2D &&
                i.Physics.Box2D.renderBody(this.context, t.body, e),
            this.stop());
        },
        bodyInfo: function (t, e, s, n) {
          t.body &&
            (this.start(e, s, n, 210),
            t.body.type === i.Physics.ARCADE
              ? i.Physics.Arcade.Body.renderBodyInfo(this, t.body)
              : t.body.type === i.Physics.BOX2D &&
          ...
          if (
            ...
            this.line(
              "  currentBatchedTextures: (" +
                s.currentBatchedTextures.length +
                ")"
            );
            ...
            this.line("  drawCount: " + n.drawCount),
              ...
              this.line(
                "  maxTextureAvailableSpace: " + n.maxTextureAvailableSpace
              ),
        ...
        phaser: function (t, e, s) {
          this.text(
            "Phaser v" +
              i.VERSION +
              " " +
              (this.game.renderType === i.WEBGL ? "WebGL" : "Canvas") +
              " " +
          ...
          this.line("Game: " + this.game.width + t + this.game.height),
            this.line(
              "Canvas: " +
                ...
                r.y.toFixed(2) +
                ") [" +
                n.aspectRatio.toFixed(2) +
                "]"
            ),
            this.line(
              "Mode: " +
                i.ScaleManager.MODES[n.currentScaleMode] +
                (n.currentScaleMode === i.ScaleManager.USER_SCALE
                  ? " (" + n._userScaleFactor.x + t + n._userScaleFactor.y + ")"
                  : "")
            ),
            this.line(
              "Parent: " +
                (n.parentIsWindow ? "window" : n.parentNode) +
                (o.empty ? "" : " (" + o.width + t + o.height + ")")
            ),
            this.line(
              "Screen: " +
                n.classifyOrientation(n.screenOrientation) +
                (n.incorrectOrientation ? " (incorrect)" : "")
            ),
            this.stop();
        },
        loader: function (t, e, s, n) {
          ...
          this.start(e, s, n),
            t.hasLoaded
              ? this.line("Complete" + (t.resetLocked ? " [locked]" : ""))
              : t.isLoading
              ? this.line("Loading")
              : this.line("Not started"),
            (t.hasLoaded && !t.resetLocked) ||
              (this.line("Progress: " + r(t.progress, 3) + "%"),
              this.line(
                "Files: " + t._loadedFileCount + " of " + t._totalFileCount
              ),
              this.line(
                "Packs: " + t._loadedPackCount + " of " + t._loadedPackCount
              )),
            this.stop();
        },
        destroy: function () {
      ...
      i.Device.whenReady(
        function (t) {
          ...
          if (
            (Object.defineProperty(i.DOM, "scrollX", { get: e }),
            Object.defineProperty(i.DOM, "scrollY", { get: s }),
            Object.defineProperty(i.DOM.visualBounds, "x", { get: e }),
            Object.defineProperty(i.DOM.visualBounds, "y", { get: s }),
            Object.defineProperty(i.DOM.layoutBounds, "x", { value: 0 }),
            Object.defineProperty(i.DOM.layoutBounds, "y", { value: 0 }),
            t.desktop &&
            ...
            Object.defineProperty(i.DOM.visualBounds, "width", { get: n }),
              Object.defineProperty(i.DOM.visualBounds, "height", { get: r }),
              Object.defineProperty(i.DOM.layoutBounds, "width", { get: n }),
              Object.defineProperty(i.DOM.layoutBounds, "height", { get: r });
          } else
          ...
          Object.defineProperty(i.DOM.documentBounds, "x", { value: 0 }),
            Object.defineProperty(i.DOM.documentBounds, "y", { value: 0 }),
      ...
      (i.ArrayUtils = {
        ...
        transposeMatrix: function (t) {
          for (
            var e = t.length, i = t[0].length, s = new Array(i), n = 0;
            n < i;
            n++
          ) {
            s[n] = new Array(e);
        ...
        rotateMatrix: function (t, e) {
          if (
            ...
            (t = t.reverse()), (t = i.ArrayUtils.transposeMatrix(t));
        ...
        numberArrayStep: function (t, e, s) {
          ...
          for (
            var n = [],
              r = Math.max(i.Math.roundAwayFromZero((e - t) / (s || 1)), 0),
              o = 0;
            o < r;
            o++
          )
      ...
      (i.LinkedList.prototype = {
        ...
        remove: function (t) {
          if (1 === this.total)
            return this.reset(), void (t.next = t.prev = null);
          t === this.first
      ...
      (i.Create.prototype = {
        texture: function (t, e, i, s, n, r, o, a) {
          ...
          for (var l = 0; l < e.length; l++)
            for (var c = e[l], d = 0; d < c.length; d++) {
              ...
              "." !== p &&
                " " !== p &&
                ((this.ctx.fillStyle = this.palettes[n][p]),
        ...
        copy: function (t, e, i, s, n, r, o) {
          return (
            null == t && (t = this.game.make.bitmapData()),
      ...
      (i.FlexGrid.prototype = {
        ...
        refresh: function () {
          (this.multiplier = Math.min(
            ...
            (this.boundsFluid.height = Math.round(
            ...
            (this.boundsFull.width = Math.round(
              this.manager.width * this.scaleFluidInversed.x
            )),
            (this.boundsFull.height = Math.round(
              this.manager.height * this.scaleFluidInversed.y
            )),
      ...
      (i.Color = {
        ...
        packPixel: function (t, e, s, n) {
          return i.Device.LITTLE_ENDIAN
            ? ((n << 24) | (s << 16) | (e << 8) | t) >>> 0
            : ((t << 24) | (e << 16) | (s << 8) | n) >>> 0;
        },
        unpackPixel: function (t, e, s, n) {
          return (
            (void 0 !== e && null !== e) || (e = i.Color.createColor()),
            (void 0 !== s && null !== s) || (s = !1),
            (void 0 !== n && null !== n) || (n = !1),
            i.Device.LITTLE_ENDIAN
              ? ((e.a = (4278190080 & t) >>> 24),
        ...
        HSLtoRGB: function (t, e, s, n) {
          if (
            (n
              ? ((n.r = s), (n.g = s), (n.b = s))
              : (n = i.Color.createColor(s, s, s)),
            0 !== e)
          ) {
            var r = s < 0.5 ? s * (1 + e) : s + e - s * e,
              o = 2 * s - r;
        ...
        RGBtoString: function (t, e, s, n, r) {
          return (
            ...
            "#" === r
              ? "#" +
                ((1 << 24) + (t << 16) + (e << 8) + s).toString(16).slice(1)
              : "0x" +
                i.Color.componentToHex(n) +
                i.Color.componentToHex(t) +
                i.Color.componentToHex(e) +
                i.Color.componentToHex(s)
          );
        },
        hexToRGB: function (t) {
        ...
        valueToColor: function (t, e) {
          if ((e || (e = i.Color.createColor()), "string" == typeof t))
            return 0 === t.indexOf("rgb")
              ? i.Color.webToColor(t, e)
              : ((e.a = 1), i.Color.hexToColor(t, e));
          if ("number" == typeof t) {
        ...
        interpolateColor: function (t, e, s, n, r, o) {
          ...
          if (1 === o) {
            var d,
              p = i.Color.RGBtoHSV(a.r, a.g, a.b),
            ...
            g > 0.5 &&
              ((p.h = p.h + 1), (d = (((f.h - p.h) * n) / s + p.h) % 1)),
              g <= 0.5 && (d = ((f.h - p.h) * n) / s + p.h);
        ...
        blendLinearLight: function (t, e) {
          return e < 128
            ? i.Color.blendLinearBurn(t, 2 * e)
            : i.Color.blendLinearDodge(t, 2 * (e - 128));
        },
        blendVividLight: function (t, e) {
          return e < 128
            ? i.Color.blendColorBurn(t, 2 * e)
            : i.Color.blendColorDodge(t, 2 * (e - 128));
        },
        blendPinLight: function (t, e) {
          return e < 128
            ? i.Color.blendDarken(t, 2 * e)
            : i.Color.blendLighten(t, 2 * (e - 128));
        },
      ...
      (i.Physics.prototype = {
        parseConfig: function () {
          (this.config.hasOwnProperty("arcade") && !0 !== this.config.arcade) ||
            !i.Physics.hasOwnProperty("Arcade") ||
            (this.arcade = new i.Physics.Arcade(this.game)),
            this.config.hasOwnProperty("ninja") &&
              !0 === this.config.ninja &&
              i.Physics.hasOwnProperty("Ninja") &&
              (this.ninja = new i.Physics.Ninja(this.game)),
            this.config.hasOwnProperty("p2") &&
              !0 === this.config.p2 &&
              i.Physics.hasOwnProperty("P2") &&
              (this.p2 = new i.Physics.P2(this.game, this.config)),
            this.config.hasOwnProperty("box2d") &&
              !0 === this.config.box2d &&
              i.Physics.hasOwnProperty("BOX2D") &&
              (this.box2d = new i.Physics.BOX2D(this.game, this.config)),
            this.config.hasOwnProperty("matter") &&
              !0 === this.config.matter &&
              i.Physics.hasOwnProperty("Matter") &&
              (this.matter = new i.Physics.Matter(this.game, this.config));
        },
        ...
        enable: function (t, e, s) {
          void 0 === e && (e = i.Physics.ARCADE),
            ...
            e === i.Physics.ARCADE
              ...
              : e === i.Physics.P2JS && this.p2
              ? this.p2.enable(t, s)
              : e === i.Physics.NINJA && this.ninja
              ? this.ninja.enableAABB(t)
              : e === i.Physics.BOX2D && this.box2d
              ? this.box2d.enable(t)
              : e === i.Physics.MATTERJS && this.matter
      ...
      void 0 === PIXI.DisplayObject._tempMatrix &&
        (PIXI.DisplayObject._tempMatrix = new i.Matrix()),
