          ...
          return void 0 === e
            ...
            : e.read().then(function (e) {
                if (e.done) {
                  ...
                  for (
                    var t = new Uint8Array(c), n = (t.set(f, 0), h), r = 0;
                    r < u.length;
                    ++r
                  )
                ...
                do {
                  if (
                    (0 === s.avail_out &&
                      ...
                      (s.next_out = 0),
                      (s.avail_out = l)),
                    (n = u.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT &&
                      d &&
                      ((a =
                        "string" == typeof d
                          ? h.string2buf(d)
                          : "[object ArrayBuffer]" === g.call(d)
                          ? new Uint8Array(d)
                          : d),
                      (n = u.inflateSetDictionary(this.strm, a))),
                    n === b.Z_BUF_ERROR && !0 === f && ((n = b.Z_OK), (f = !1)),
            ...
            "utils/strings.js": function (e, t, n) {
              ...
              (d[254] = d[254] = 1),
                (n.string2buf = function (e) {
                  for (var t, n, r, o, i = e.length, a = 0, s = 0; s < i; s++)
              ...
              function a(e) {
                ...
                return e && e.state
                  ? ((t = e.state),
                    ...
                    (t.hold = 0),
                    (t.bits = 0),
                    (t.lencode = t.lendyn = new R.Buf32(r)),
                ...
                return (
                  ...
                  r >= e.wsize
                    ...
                    : (r < (o = e.wsize - e.wnext) && (o = r),
                      R.arraySet(e.window, t, n - r, o, e.wnext),
                      (r -= o)
                        ? (R.arraySet(e.window, t, n - r, r, 0),
                          (e.wnext = r),
                          (e.whave = e.wsize))
                        : ((e.wnext += o),
                    ...
                    switch (n.mode) {
                        ...
                        if (
                          ...
                          ((h = s < (h = n.length) ? s : h) &&
                            (n.head &&
                              ...
                              R.arraySet(n.head.extra, r, i, h, _)),
                            512 & n.flags && (n.check = O(n.check, r, h, i)),
                            (s -= h),
                            (i += h),
                            (n.length -= h)),
                          n.length)
                            ...
                            case 1:
                              ...
                              if (W) {
                                ...
                                for (
                                  ...
                                  T.lens[L++] = 5;
                                P(2, T.lens, 0, 32, H, 0, T.work, { bits: 5 }),
                                  (W = !1);
                              }
                              if (
                                ((T.lencode = D),
                      ...
                      case 18:
                        ...
                        if (
                          ...
                          (n.lenbits = 7),
                          (S = { bits: n.lenbits }),
                          (x = P(0, n.lens, 0, 19, n.lencode, 0, n.work, S)),
                          (n.lenbits = S.bits),
                          x)
                        ) {
                      ...
                      case 27:
                        if (n.wrap) {
                          ...
                          if (
                            ...
                            c &&
                              (e.adler = n.check =
                                (n.flags ? O : A)(n.check, o, c, a - c)),
                            (c = l),
                            (n.flags ? d : Z(d)) !== n.check)
                          ) {
                  ...
                  return (
                    ...
                    (n.wsize ||
                      (c !== e.avail_out &&
                        n.mode < 30 &&
                        (n.mode < 27 || 4 !== t))) &&
                    j(e, e.output, e.next_out, c - e.avail_out)
                      ? ((n.mode = 31), -4)
                      : ((u -= e.avail_in),
                        (c -= e.avail_out),
                        (e.total_in += u),
                        ...
                        n.wrap &&
                          c &&
                          (e.adler = n.check =
                            (n.flags ? O : A)(n.check, o, c, e.next_out - c)),
                        (e.data_type =
                          n.bits +
                          (n.last ? 64 : 0) +
                          (12 === n.mode ? 128 : 0) +
