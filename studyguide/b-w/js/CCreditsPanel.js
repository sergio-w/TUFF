function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text("DEVELOPED BY"," 30px "+SECONDARY_FONT, "#1ef400");
        ...
        var oLink = new createjs.Text("www.codethislab.com"," 30px "+SECONDARY_FONT, "#1ef400");
        oLink.y = 80;
        ...
        _oButExit = new CGfxButton(210, -122, oSprite, _oPanelContainer);
