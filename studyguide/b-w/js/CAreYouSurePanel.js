function CAreYouSurePanel(oFunction) {
    ...
    this._init = function (oFunction) {
        ...
        var oTitleStroke = new createjs.Text(TEXT_ARE_SURE," 50px "+SECONDARY_FONT, "#000000");
        ...
        var oTitle = new createjs.Text(TEXT_ARE_SURE," 50px "+SECONDARY_FONT, "#1ef400");
        ...
        _oButNo = new CGfxButton(-110, 80, s_oSpriteLibrary.getSprite('but_not'), _oPanelContainer);
