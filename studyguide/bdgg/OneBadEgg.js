var Godot = (function () {
  ...
  return function (Godot) {
    ...
    var STACK_MAX = 3508368,
      DYNAMIC_BASE = 8751248,
      DYNAMICTOP_PTR = 3508208;
    ...
    var ___tm_timezone = (stringToUTF8("GMT", 3508272, 4), 3508272);
    ...
    var MONO = {
      ...
      mono_wasm_setenv: function (name, value) {
        if (!this.wasm_setenv)
          this.wasm_setenv = Module.cwrap("mono_wasm_setenv", null, [
            "string",
            "string",
          ]);
            ...
            .then(function (response) {
              if (!response.ok) {
                if (
                  ...
                  --pending;
                  throw (
                    "MONO-WASM: Skipping failed load for .pdb file: '" +
                    file_name +
                    "'"
                  );
                } else {
              ...
              if (pending == 0) {
                ...
                if (ENVIRONMENT_IS_SHELL || ENVIRONMENT_IS_NODE) {
                  try {
                    ...
                    print(err.stack);
                    var wasm_exit = Module.cwrap("mono_wasm_exit", null, [
                      "number",
                    ]);
                    wasm_exit(1);
                  }
    ...
    var BINDING = {
      ...
      export_functions: function (module) {
        ...
        module["mono_bind_assembly_entry_point"] =
          BINDING.bind_assembly_entry_point.bind(BINDING);
        module["mono_call_assembly_entry_point"] =
          BINDING.call_assembly_entry_point.bind(BINDING);
      },
      ...
      unbox_mono_obj: function (mono_obj) {
        ...
        switch (type) {
          ...
          case 22:
            var uriValue = this.call_method(this.object_to_string, null, "m", [
              mono_obj,
            ]);
            return uriValue;
          default:
      ...
      call_method: function (method, this_arg, args_marshal, args) {
        ...
        var args_mem = null;
        var has_args =
          args !== null && typeof args !== "undefined" && args.length > 0;
        var has_args_marshal =
          args_marshal !== null &&
          typeof args_marshal !== "undefined" &&
          args_marshal.length > 0;
        if (
          has_args_marshal &&
          (!has_args || args.length < args_marshal.leghth)
        )
      ...
      bind_assembly_entry_point: function (assembly) {
        ...
        if (!method)
          throw new Error(
            "Could not find entry point for assembly: " + assembly
          );
        if (typeof signature === "undefined")
          signature = Module.mono_method_get_call_signature(method);
        return function () {
    ...
    var _fflush = (Module["_fflush"] = function () {
      return (_fflush = Module["_fflush"] = Module["asm"]["Nl"]).apply(
        null,
        arguments
      );
    });
    ...
    var _mono_wasm_setup_single_step = (Module["_mono_wasm_setup_single_step"] =
      function () {
        return (_mono_wasm_setup_single_step = Module[
    ...
    var _mono_wasm_clear_all_breakpoints = (Module[
      ...
      return (_mono_wasm_clear_all_breakpoints = Module[
        "_mono_wasm_clear_all_breakpoints"
      ] =
    ...
    var _mono_wasm_set_breakpoint = (Module["_mono_wasm_set_breakpoint"] =
      function () {
        return (_mono_wasm_set_breakpoint = Module[
    ...
    var _mono_wasm_remove_breakpoint = (Module["_mono_wasm_remove_breakpoint"] =
      function () {
        return (_mono_wasm_remove_breakpoint = Module[
    ...
    var _mono_wasm_get_object_properties = (Module[
      ...
      return (_mono_wasm_get_object_properties = Module[
        "_mono_wasm_get_object_properties"
      ] =
    ...
    var _mono_wasm_get_array_values = (Module["_mono_wasm_get_array_values"] =
      function () {
        return (_mono_wasm_get_array_values = Module[
    ...
    var _malloc = (Module["_malloc"] = function () {
      return (_malloc = Module["_malloc"] = Module["asm"]["_l"]).apply(
        null,
        arguments
      );
    });
    var _htonl = (Module["_htonl"] = function () {
      return (_htonl = Module["_htonl"] = Module["asm"]["$l"]).apply(
        null,
        arguments
      );
    });
    var _htons = (Module["_htons"] = function () {
      return (_htons = Module["_htons"] = Module["asm"]["am"]).apply(
        null,
        arguments
      );
    });
    var _ntohs = (Module["_ntohs"] = function () {
      return (_ntohs = Module["_ntohs"] = Module["asm"]["bm"]).apply(
        null,
        arguments
      );
    });
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["cm"]).apply(
        null,
        arguments
      );
    });
    ...
    var _realloc = (Module["_realloc"] = function () {
      return (_realloc = Module["_realloc"] = Module["asm"]["em"]).apply(
        null,
        arguments
      );
    });
    ...
    var _main = (Module["_main"] = function () {
      return (_main = Module["_main"] = Module["asm"]["gm"]).apply(
        null,
        arguments
      );
    });
    ...
    var _mono_wasm_string_get_utf8 = (Module["_mono_wasm_string_get_utf8"] =
      function () {
        return (_mono_wasm_string_get_utf8 = Module[
    ...
    var _mono_wasm_string_from_js = (Module["_mono_wasm_string_from_js"] =
      function () {
        return (_mono_wasm_string_from_js = Module[
    ...
    var _mono_unbox_int = (Module["_mono_unbox_int"] = function () {
      return (_mono_unbox_int = Module["_mono_unbox_int"] =
    ...
    var _mono_wasm_array_get = (Module["_mono_wasm_array_get"] = function () {
      return (_mono_wasm_array_get = Module["_mono_wasm_array_get"] =
    ...
    var _mono_wasm_string_array_new = (Module["_mono_wasm_string_array_new"] =
      function () {
        return (_mono_wasm_string_array_new = Module[
    ...
    var ___em_js__compile_funtion = (Module["___em_js__compile_funtion"] =
      function () {
        return (___em_js__compile_funtion = Module[
          "___em_js__compile_funtion"
        ] =
          Module["asm"]["Fm"]).apply(null, arguments);
      });
    var _mono_wasm_typed_array_new = (Module["_mono_wasm_typed_array_new"] =
      function () {
        return (_mono_wasm_typed_array_new = Module[
    ...
    var _mono_wasm_unbox_enum = (Module["_mono_wasm_unbox_enum"] = function () {
      return (_mono_wasm_unbox_enum = Module["_mono_wasm_unbox_enum"] =
        Module["asm"]["Hm"]).apply(null, arguments);
    });
    ...
    var _setThrew = (Module["_setThrew"] = function () {
      return (_setThrew = Module["_setThrew"] = Module["asm"]["Nm"]).apply(
        null,
        arguments
      );
    });
    ...
    var _memalign = (Module["_memalign"] = function () {
      return (_memalign = Module["_memalign"] = Module["asm"]["Sm"]).apply(
        null,
        arguments
      );
    });
    var dynCall_v = (Module["dynCall_v"] = function () {
      return (dynCall_v = Module["dynCall_v"] = Module["asm"]["Tm"]).apply(
        null,
        arguments
      );
    });
    var dynCall_vi = (Module["dynCall_vi"] = function () {
      return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["Um"]).apply(
        null,
        arguments
      );
    });
    var dynCall_vii = (Module["dynCall_vii"] = function () {
      return (dynCall_vii = Module["dynCall_vii"] = Module["asm"]["Vm"]).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_ii = (Module["dynCall_ii"] = function () {
      return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["Zm"]).apply(
        null,
        arguments
      );
    });
    var dynCall_iii = (Module["dynCall_iii"] = function () {
      return (dynCall_iii = Module["dynCall_iii"] = Module["asm"]["_m"]).apply(
        null,
        arguments
      );
    });
    ...
    var stackSave = (Module["stackSave"] = function () {
      return (stackSave = Module["stackSave"] = Module["asm"]["fn"]).apply(
        null,
        arguments
      );
    });
    var stackAlloc = (Module["stackAlloc"] = function () {
      return (stackAlloc = Module["stackAlloc"] = Module["asm"]["gn"]).apply(
        null,
        arguments
      );
    });
    ...
    const proto = /** @lends Engine.prototype */ {
      ...
      init: function (basePath) {
        ...
        if (loadPromise == null) {
          ...
          Engine.load(
            basePath,
            this.config.fileSizes[`${basePath}.wasm?nocache=257`]
          );
        }
        const me = this;
      ...
      startGame: function (override) {
        ...
        const pack = this.config.mainPack || `${exe}.pck?nocache=257`;
